...
var h=[];c.first().find("td").each(function(){var f=$j(this).data("column-id");f&&h.push(f)});var d={action:e,booking_id:b,context:bookacti_localized.is_admin?"admin_booking_list":"user_booking_list",columns:h,nonce:bookacti_localized.nonce_cancel_booking};c.first().trigger("bookacti_booking_action_data",[d,b,a,"cancel"]);bookacti_add_loading_html($j("#bookacti-cancel-booking-dialog"));bookacti_booking_row_enter_loading_state(l);$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:d,dataType:"json",
...
$j("#bookacti-refund-booking-dialog #bookacti-refund-amount-container").hide();if("single"===a){var l=$j('.bookacti-refund-booking[data-booking-id="'+b+'"]').closest("tr");var h=$j('.bookacti-refund-booking[data-booking-id="'+b+'"]').closest("tr, .bookacti-booking-row")}else l=$j('.bookacti-refund-booking-group[data-booking-group-id="'+b+'"]').closest("tr"),h=$j('.bookacti-refund-booking-group[data-booking-group-id="'+b+'"]').closest("tr, .bookacti-booking-row");bookacti_localized.is_admin&&"undefined"!==
...
$j("#bookacti-refund-booking-dialog #bookacti-refund-options-container").show(),d.amount&&($j("#bookacti-refund-booking-dialog #bookacti-refund-amount").html(d.amount),$j("#bookacti-refund-booking-dialog #bookacti-refund-amount-container").show()),$j('#bookacti-refund-booking-form input[type="radio"]:first').prop("checked",!0),l.first().trigger("bookacti_booking_action_dialog_opened",[b,a,"refund"]),f.push({text:bookacti_localized.dialog_button_refund,"class":"bookacti-dialog-delete-button",click:function(){$j("#bookacti-refund-booking-dialog .bookacti-notices").remove();
var m=0;l.first().closest("#bookacti-booking-list").length&&(m=l.next().hasClass("bookacti-gouped-booking")?1:0);h.find(".bookacti-booking-state").hide();bookacti_add_loading_html(h.find(".bookacti-booking-state"),"after");bookacti_add_loading_html($j("#bookacti-refund-booking-dialog"));var g=$j('#bookacti-refund-booking-form input[name="refund-action"]:checked').val(),n=$j('#bookacti-refund-message textarea[name="refund-message"]').val(),p=[];l.first().find("td").each(function(){var k=$j(this).data("column-id");
k&&p.push(k)});var q={action:c,booking_id:b,refund_action:g,refund_message:n,reload_grouped_bookings:m,is_admin:bookacti_localized.is_admin?1:0,context:bookacti_localized.is_admin?"admin_booking_list":"user_booking_list",columns:p,nonce:bookacti_localized.nonce_refund_booking};l.first().trigger("bookacti_booking_action_data",[q,b,a,"refund"]);$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:q,dataType:"json",success:function(k){if("success"===k.status)m&&"undefined"!==typeof k.grouped_booking_rows&&
l.each(function(){var t=$j(this).next().hasClass("hidden");$j(this).nextUntil("tr:not(.bookacti-gouped-booking)").remove();$j(this).after(k.grouped_booking_rows);t&&($j(this).nextUntil("tr:not(.bookacti-gouped-booking)").addClass("hidden"),$j(this).nextUntil("tr:not(.bookacti-gouped-booking)").length%2&&$j(this).after('<tr class="bookacti-gouped-booking hidden dummy"></tr>'))}),k.row&&(l.last().after(k.row),l.remove(),bookacti_refresh_list_table_hidden_columns()),$j("body").trigger("bookacti_booking_refunded",
[b,a,g,n,k]),$j("#bookacti-refund-booking-dialog").dialog("close"),k.message&&bookacti_dialog_refund_confirmation(k.message);else if("failed"===k.status){var r="undefined"!==typeof k.message?k.message:bookacti_localized.error;$j("#bookacti-refund-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+r+"</li></ul></div>");console.log(r);console.log(k)}},error:function(k){console.log("AJAX "+bookacti_localized.error);console.log(k)},complete:function(){$j("#bookacti-refund-booking-dialog .bookacti-notices").show();
bookacti_remove_loading_html($j("#bookacti-refund-booking-dialog"));bookacti_remove_loading_html(h);h.find(".bookacti-booking-state").show()}})}})):$j("#bookacti-refund-booking-dialog #bookacti-no-refund-option").show();f.push({text:bookacti_localized.dialog_button_cancel,click:function(){$j(this).dialog("close")}});$j("#bookacti-refund-booking-dialog").dialog("option","buttons",f)}else"failed"===d.status&&(f="undefined"!==typeof d.message?d.message:bookacti_localized.error,$j("#bookacti-refund-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
...
function bookacti_dialog_change_booking_state(b,a){a="group"===a?"group":"single";var e="group"===a?"bookactiChangeBookingGroupState":"bookactiChangeBookingState";var c="single"===a?$j('.bookacti-change-booking-state[data-booking-id="'+b+'"]').closest("tr"):$j('.bookacti-change-booking-group-state[data-booking-group-id="'+b+'"]').closest("tr");var l=c.first().closest("#bookacti-booking-list").length?1:0,h=l&&c.next().hasClass("bookacti-gouped-booking")?1:0,d=c.first().find(".bookacti-booking-state").data("booking-state"),
...
g=$j("select#bookacti-select-payment-status").val(),n=$j("#bookacti-send-notifications-on-state-change").prop("checked")?1:0,p=$j('#bookacti-change-booking-state-dialog input[name="nonce"]').val();if((m||g)&&(m!==d||g!==f)){$j("#bookacti-change-booking-state-dialog .bookacti-notices").remove();var q=[];c.first().find("td").each(function(){var k=$j(this).data("column-id");k&&q.push(k)});n={action:e,booking_id:b,new_booking_state:d!==m?m:0,new_payment_status:g,send_notifications:n,is_bookings_page:l,
is_admin:bookacti_localized.is_admin?1:0,context:bookacti_localized.is_admin?"admin_booking_list":"user_booking_list",columns:q,reload_grouped_bookings:h,nonce:p};c.first().trigger("bookacti_booking_action_data",[n,b,a,"change_booking_status"]);bookacti_booking_row_enter_loading_state(c);bookacti_add_loading_html($j("#bookacti-change-booking-state-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:n,dataType:"json",success:function(k){if("success"===k.status)$j("#bookacti-change-booking-state-dialog").dialog("close"),
h&&"undefined"!==typeof k.grouped_booking_rows&&c.each(function(){var t=$j(this).next().hasClass("hidden");$j(this).nextUntil("tr:not(.bookacti-gouped-booking)").remove();$j(this).after(k.grouped_booking_rows);t&&($j(this).nextUntil("tr:not(.bookacti-gouped-booking)").addClass("hidden"),$j(this).nextUntil("tr:not(.bookacti-gouped-booking)").length%2&&$j(this).after('<tr class="bookacti-gouped-booking hidden dummy"></tr>'))}),k.row&&(c.last().after(k.row),c.remove(),bookacti_refresh_list_table_hidden_columns()),
d!==m&&$j("body").trigger("bookacti_booking_state_changed",[b,a,m,d,l,k.active_changed]),f!==g&&$j("body").trigger("bookacti_payment_status_changed",[b,a,g,f,l,k.active_changed]);else if("failed"===k.status){var r="undefined"!==typeof k.message?k.message:bookacti_localized.error;$j("#bookacti-change-booking-state-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+r+"</li></ul></div>").show();console.log(r);console.log(k)}},error:function(k){$j("#bookacti-change-booking-state-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+
bookacti_localized.error+"</li></ul></div>").show();console.log("AJAX "+bookacti_localized.error);console.log(k)},complete:function(){$j("#bookacti-change-booking-state-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-change-booking-state-dialog"));bookacti_booking_row_exit_loading_state(c)}})}}},{text:bookacti_localized.dialog_button_cancel,click:function(){$j(this).dialog("close")}}]);$j("#bookacti-change-booking-state-dialog").dialog("open")}
function bookacti_dialog_change_booking_quantity(b,a){a="group"===a?"group":"single";var e="single"===a?$j('.bookacti-change-booking-quantity[data-booking-id="'+b+'"]').closest("tr"):$j('.bookacti-change-booking-group-quantity[data-booking-group-id="'+b+'"]').closest("tr");var c=e.first().closest("#bookacti-booking-list").length?1:0,l=c&&e.next().hasClass("bookacti-gouped-booking")?1:0,h=parseInt(e.first().find(".column-quantity").text());$j("#bookacti-new-quantity").val(h);e.first().trigger("bookacti_booking_action_dialog_opened",
...
click:function(){var l=$j("#bookacti-booking-notification-id").val();if(l){$j("#bookacti-send-booking-notification-dialog .bookacti-notices").remove();var h=bookacti_serialize_object($j("#bookacti-send-booking-notification-dialog-form"));h.action="bookactiSendBookingNotification";h.booking_id=b;h.booking_type=a;h.is_bookings_page=c;h.is_admin=bookacti_localized.is_admin?1:0;h.context=bookacti_localized.is_admin?"admin_booking_list":"user_booking_list";e.first().trigger("bookacti_booking_action_data",
[h,b,a,"send_notification"]);bookacti_booking_row_enter_loading_state(e);bookacti_add_loading_html($j("#bookacti-send-booking-notification-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:h,dataType:"json",success:function(d){if("success"===d.status)$j("#bookacti-send-booking-notification-dialog").dialog("close"),$j("body").trigger("bookacti_booking_notification_sent",[l,b,a]);else if("failed"===d.status){var f="undefined"!==typeof d.message?d.message:bookacti_localized.error;$j("#bookacti-send-booking-notification-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
...
bookacti_localized.is_admin?"admin_booking_list":"user_booking_list";c.first().trigger("bookacti_booking_action_data",[l,b,a,"delete"]);bookacti_booking_row_enter_loading_state(c);bookacti_add_loading_html($j("#bookacti-delete-booking-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:l,dataType:"json",success:function(h){if("success"===h.status){$j("#bookacti-delete-booking-dialog").dialog("close");if("group"===a&&$j(".bookacti-booking-group-id-"+b).length){var d=$j(".bookacti-booking-group-id-"+
b);d.removeClass("bookacti-gouped-booking").animate({opacity:0},function(){d.children("td, th").animate({padding:0}).wrapInner("<div></div>").children().slideUp(function(){d.remove()})})}c.animate({opacity:0},function(){c.children("td, th").animate({padding:0}).wrapInner("<div></div>").children().slideUp(function(){c.remove()})});$j("body").trigger("bookacti_booking_deleted",[b,a,h])}else if("failed"===h.status){var f="undefined"!==typeof h.message?h.message:bookacti_localized.error;$j("#bookacti-delete-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
f+"</li></ul></div>");console.log(f);console.log(h)}},error:function(h){$j("#bookacti-delete-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>");console.log("AJAX "+bookacti_localized.error);console.log(h)},complete:function(){$j("#bookacti-delete-booking-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-delete-booking-dialog"));bookacti_booking_row_exit_loading_state(c)}})}},{text:bookacti_localized.dialog_button_cancel,
