...
!1})}
function bookacti_dialog_update_bookings_calendar_settings(){$j("#bookacti-bookings-calendar-settings-dialog .bookacti-notices").remove();$j("#bookacti-bookings-calendar-settings-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_ok,click:function(){$j("#bookacti-bookings-calendar-settings-dialog .bookacti-notices").remove();$j("#bookacti-bookings-calendar-settings-dialog select[multiple].bookacti-items-select-box option").prop("selected",!0);var b=$j("#bookacti-bookings-calendar-settings-form").serializeObject();$j("body").trigger("bookacti_bookings_calendar_settings_data",
[b]);bookacti_add_loading_html($j("#bookacti-bookings-calendar-settings-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:b,dataType:"json",success:function(a){if("success"===a.status){bookacti.booking_system["bookacti-booking-system-bookings-page"].display_data=a.display_data;bookacti.booking_system["bookacti-booking-system-bookings-page"].tooltip_booking_list=a.calendar_settings.tooltip_booking_list;bookacti.booking_system["bookacti-booking-system-bookings-page"].tooltip_booking_list_columns=
a.calendar_settings.booking_list_columns;$j("body").trigger("bookacti_bookings_calendar_settings_updated",[b,a]);var d=$j("#bookacti-booking-system-bookings-page");bookacti_reload_booking_system(d,!0);$j("#bookacti-submit-filter-button").attr("data-ajax",a.calendar_settings.ajax).data("ajax",a.calendar_settings.ajax);$j("#bookacti-bookings-calendar-settings-dialog").dialog("close")}else if("failed"===a.status){d="undefined"!==typeof a.message?a.message:"";if(!d){d+="Error while trying to update calendar settings";
var c="undefined"!==typeof a.error?a.error:"";c&&(d+=" ("+c+")")}$j("#bookacti-bookings-calendar-settings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+d+"</li></ul></div>");console.log(d);console.log(a)}},error:function(a){$j("#bookacti-bookings-calendar-settings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX error while trying to update calendar settings</li></ul></div>');console.log("AJAX error while trying to update calendar settings");
console.log(a)},complete:function(){$j("#bookacti-bookings-calendar-settings-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-bookings-calendar-settings-dialog"))}})}},{text:bookacti_localized.dialog_button_cancel,click:function(){$j(this).dialog("close")}}]);$j("#bookacti-bookings-calendar-settings-dialog").dialog("open")}
...
f=c.first().find(".bookacti-payment-status").data("payment-status");e&&$j('#bookacti-select-booking-state option[value="'+e+'"]').prop("selected",!0);f&&$j('#bookacti-select-payment-status option[value="'+f+'"]').prop("selected",!0);$j("#bookacti-send-notifications-on-state-change").prop("checked",!1);$j("#bookacti-change-booking-state-dialog .bookacti-notices").remove();$j("#bookacti-change-booking-state-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_ok,click:function(){var m=
$j("select#bookacti-select-booking-state").val(),g=$j("select#bookacti-select-payment-status").val(),n=$j("#bookacti-send-notifications-on-state-change").prop("checked")?1:0,p=$j("#bookacti-change-booking-state-dialog #nonce_change_booking_state").val();if((m||g)&&(m!==e||g!==f)){$j("#bookacti-change-booking-state-dialog .bookacti-notices").remove();var q=[];c.first().find("td").each(function(){var h=$j(this).data("column-id");h&&q.push(h)});n={action:d,booking_id:b,new_booking_state:e!==m?m:0,new_payment_status:g,
send_notifications:n,is_bookings_page:k,is_admin:bookacti_localized.is_admin?1:0,context:bookacti_localized.is_admin?"admin_booking_list":"user_booking_list",columns:q,reload_grouped_bookings:l,nonce:p};c.first().trigger("bookacti_booking_action_data",[n,b,a,"change_state"]);bookacti_booking_row_enter_loading_state(c);bookacti_add_loading_html($j("#bookacti-change-booking-state-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:n,dataType:"json",success:function(h){if("success"===
h.status)$j("#bookacti-change-booking-state-dialog").dialog("close"),l&&"undefined"!==typeof h.grouped_booking_rows&&c.each(function(){var t=$j(this).next().hasClass("hidden");$j(this).nextUntil("tr:not(.bookacti-gouped-booking)").remove();$j(this).after(h.grouped_booking_rows);t&&($j(this).nextUntil("tr:not(.bookacti-gouped-booking)").addClass("hidden"),$j(this).nextUntil("tr:not(.bookacti-gouped-booking)").length%2&&$j(this).after('<tr class="bookacti-gouped-booking hidden dummy"></tr>'))}),h.row&&
(c.last().after(h.row),c.remove(),bookacti_refresh_list_table_hidden_columns()),e!==m&&$j("body").trigger("bookacti_booking_state_changed",[b,a,m,e,k,h.active_changed]),f!==g&&$j("body").trigger("bookacti_payment_status_changed",[b,a,g,f,k,h.active_changed]);else if("failed"===h.status){var r="undefined"!==typeof h.message?h.message:bookacti_localized.error;$j("#bookacti-change-booking-state-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+r+"</li></ul></div>").show();
console.log(r);console.log(h)}},error:function(h){$j("#bookacti-change-booking-state-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>").show();console.log("AJAX "+bookacti_localized.error);console.log(h)},complete:function(){$j("#bookacti-change-booking-state-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-change-booking-state-dialog"));bookacti_booking_row_exit_loading_state(c)}})}}},
{text:bookacti_localized.dialog_button_cancel,click:function(){$j(this).dialog("close")}}]);$j("#bookacti-change-booking-state-dialog").dialog("open")}
...
function bookacti_generate_export_bookings_url(b){b=b||!1;$j("#bookacti-export-bookings-dialog .bookacti-notices").remove();bookacti_add_loading_html($j("#bookacti-export-bookings-dialog"));$j("#bookacti-export-bookings-dialog select[multiple].bookacti-items-select-box option").prop("selected",!0);var a=$j("#bookacti-export-bookings-form").serializeObject();a.action="bookactiExportBookingsUrl";a.reset_key=b?1:0;a.booking_filters=$j("#bookacti-booking-list-filters-form").serializeObject();$j("#bookacti-export-bookings-form").trigger("bookacti_export_bookings_url_data",
[a,b]);$j.ajax({url:ajaxurl,type:"POST",data:a,dataType:"json",success:function(d){if("success"===d.status)$j("#bookacti_export_bookings_url_secret").val(d.url),$j("#bookacti-export-bookings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-success-list"><li>'+d.message+"</li></ul></div>").show(),$j("#bookacti-export-bookings-url-container").data("export-type",a.export_type),$j("#bookacti-export-bookings-url-container").show(),$j("#bookacti-form-editor").trigger("bookacti_export_bookings_url",
[d]);else if("failed"===d.status){var c="undefined"!==typeof d.message?d.message:bookacti_localized.error;$j("#bookacti-export-bookings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+c+"</li></ul></div>").show();console.log(c);console.log(d)}},error:function(d){$j("#bookacti-export-bookings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>").show();console.log("AJAX "+bookacti_localized.error);
console.log(d)},complete:function(){$j("#bookacti-export-bookings-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-export-bookings-dialog"))}})};
