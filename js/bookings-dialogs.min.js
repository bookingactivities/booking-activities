...
data:c.form_data,dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(d){if("success"===d.status){$j("#bookacti-cancel-booking-dialog").dialog("close");if(d.rows){var h=$j(d.rows);a.each(function(){var f=$j(this).find(".bookacti-single-booking").addBack(".bookacti-single-booking").data("booking-id"),k=$j(this).find(".bookacti-booking-group").addBack(".bookacti-booking-group").data("booking-group-id");f=(f=f?'.bookacti-single-booking[data-booking-id="'+f+'"]':k?'.bookacti-booking-group[data-booking-group-id="'+
k+'"]':"")?h.find(f).addBack(f).closest("tr"):$j();f.length&&$j(this).replaceWith(f);k&&$j('.bookacti-gouped-booking[data-booking-group-id="'+k+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}a.remove();$j("body").trigger("bookacti_bookings_cancelled",[d,b]);d.allow_refund&&bookacti_dialog_refund_bookings(b)}else if("failed"===d.status){var g="undefined"!==typeof d.message?d.message:bookacti_localized.error;$j("#bookacti-cancel-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
g+"</li></ul></div>");console.log(g);console.log(d)}},error:function(d){$j("#bookacti-cancel-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>");console.log("AJAX "+bookacti_localized.error);console.log(d)},complete:function(){$j("#bookacti-cancel-booking-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-cancel-booking-dialog"));bookacti_booking_row_exit_loading_state(a)}})}},{text:bookacti_localized.dialog_button_cancel,
...
!0),$j("#bookacti-refund-booking-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_refund,"class":"bookacti-dialog-delete-button",click:function(){if($j('#bookacti-refund-booking-form input[name="refund_action"]').val()){$j("#bookacti-refund-booking-dialog .bookacti-notices").remove();var h=[];a.first().find("td").each(function(){var f=$j(this).data("column-id");f&&h.push(f)});var g={form_data:new FormData($j("#bookacti-refund-booking-form").get(0))};g.form_data.append("action",
"bookactiRefundBookings");g.form_data.append("booking_selection",JSON.stringify(b));g.form_data.append("columns",JSON.stringify(h));g.form_data.append("is_admin",bookacti_localized.is_admin?1:0);g.form_data.append("user_auth_key","undefined"!==typeof user_auth_key?user_auth_key:"");$j("body").trigger("bookacti_booking_action_data",[g,b,"refund"]);bookacti_booking_row_enter_loading_state(a);bookacti_add_loading_html($j("#bookacti-refund-booking-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",
data:g.form_data,dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(f){if("success"===f.status){$j("#bookacti-refund-booking-dialog").dialog("close");if(f.rows){var k=$j(f.rows);a.each(function(){var m=$j(this).find(".bookacti-single-booking").addBack(".bookacti-single-booking").data("booking-id"),l=$j(this).find(".bookacti-booking-group").addBack(".bookacti-booking-group").data("booking-group-id");m=(m=m?'.bookacti-single-booking[data-booking-id="'+m+'"]':l?'.bookacti-booking-group[data-booking-group-id="'+
l+'"]':"")?k.find(m).addBack(m).closest("tr"):$j();m.length&&$j(this).replaceWith(m);l&&$j('.bookacti-gouped-booking[data-booking-group-id="'+l+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}a.remove();f.message&&bookacti_dialog_refund_confirmation(f.message);$j("body").trigger("bookacti_booking_refunded",[f,b]);f.rows||window.location.reload()}else if("failed"===f.status){var n="undefined"!==typeof f.message?f.message:bookacti_localized.error;$j("#bookacti-refund-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
n+"</li></ul></div>");console.log(n);console.log(f)}},error:function(f){console.log("AJAX "+bookacti_localized.error);console.log(f)},complete:function(){$j("#bookacti-refund-booking-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-refund-booking-dialog"));bookacti_booking_row_exit_loading_state(a)}})}}},{text:bookacti_localized.dialog_button_cancel,click:function(){$j(this).dialog("close")}}])):$j("#bookacti-refund-booking-dialog #bookacti-no-refund-option").show();else if("failed"===
c.status){var d="undefined"!==typeof c.message?c.message:bookacti_localized.error;$j("#bookacti-refund-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+d+"</li></ul></div>");console.log(d);console.log(c)}},error:function(c){$j("#bookacti-refund-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>");console.log("AJAX "+bookacti_localized.error);console.log(c)},complete:function(){$j("#bookacti-refund-booking-dialog .bookacti-notices").show();
bookacti_remove_loading_html($j("#bookacti-refund-booking-dialog"));bookacti_booking_row_exit_loading_state(a)}});$j("#bookacti-refund-booking-dialog").dialog("open")}function bookacti_dialog_refund_confirmation(b){$j("#bookacti-refund-booking-confirm-dialog").html(b);$j("#bookacti-refund-booking-confirm-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_ok,click:function(){$j(this).dialog("close")}}]);$j("#bookacti-refund-booking-confirm-dialog").dialog("open")}
...
h=$j("select#bookacti-select-payment-status").val();if((d||h)&&(d!==e||h!==c)){$j("#bookacti-change-booking-status-dialog .bookacti-notices").remove();var g=[];a.first().find("td").each(function(){var k=$j(this).data("column-id");k&&g.push(k)});var f={form_data:new FormData($j("#bookacti-change-booking-status-form").get(0))};f.form_data.append("action","bookactiChangeBookingsStatus");f.form_data.append("booking_selection",JSON.stringify(b));f.form_data.append("columns",JSON.stringify(g));f.form_data.append("is_admin",
bookacti_localized.is_admin?1:0);$j("body").trigger("bookacti_booking_action_data",[f,b,"change_booking_status"]);bookacti_booking_row_enter_loading_state(a);bookacti_add_loading_html($j("#bookacti-change-booking-status-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:f.form_data,dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(k){if("success"===k.status){$j("#bookacti-change-booking-status-dialog").dialog("close");if(k.rows){var n=$j(k.rows);a.each(function(){var l=
$j(this).find(".bookacti-single-booking").addBack(".bookacti-single-booking").data("booking-id"),p=$j(this).find(".bookacti-booking-group").addBack(".bookacti-booking-group").data("booking-group-id");l=(l=l?'.bookacti-single-booking[data-booking-id="'+l+'"]':p?'.bookacti-booking-group[data-booking-group-id="'+p+'"]':"")?n.find(l).addBack(l).closest("tr"):$j();l.length&&$j(this).replaceWith(l);p&&$j('.bookacti-gouped-booking[data-booking-group-id="'+p+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}a.remove();
d&&$j("body").trigger("bookacti_booking_status_changed",[k,b,d]);h&&$j("body").trigger("bookacti_payment_status_changed",[k,b,h]);k.rows||window.location.reload()}else if("failed"===k.status){var m="undefined"!==typeof k.message?k.message:bookacti_localized.error;$j("#bookacti-change-booking-status-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+m+"</li></ul></div>").show();console.log(m);console.log(k)}},error:function(k){$j("#bookacti-change-booking-status-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+
...
cache:!1,contentType:!1,processData:!1,success:function(g){if("success"===g.status){$j("#bookacti-change-booking-quantity-dialog").dialog("close");if(g.rows){var f=$j(g.rows);a.each(function(){var n=$j(this).find(".bookacti-single-booking").addBack(".bookacti-single-booking").data("booking-id"),m=$j(this).find(".bookacti-booking-group").addBack(".bookacti-booking-group").data("booking-group-id");n=(n=n?'.bookacti-single-booking[data-booking-id="'+n+'"]':m?'.bookacti-booking-group[data-booking-group-id="'+
m+'"]':"")?f.find(n).addBack(n).closest("tr"):$j();n.length&&$j(this).replaceWith(n);m&&$j('.bookacti-gouped-booking[data-booking-group-id="'+m+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}a.remove();$j("body").trigger("bookacti_booking_quantity_changed",[g,b,c]);g.rows||window.location.reload()}else if("failed"===g.status){var k="undefined"!==typeof g.message?g.message:bookacti_localized.error;$j("#bookacti-change-booking-quantity-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
k+"</li></ul></div>").show();console.log(k);console.log(g)}},error:function(g){$j("#bookacti-change-booking-quantity-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>").show();console.log("AJAX "+bookacti_localized.error);console.log(g)},complete:function(){$j("#bookacti-change-booking-quantity-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-change-booking-quantity-dialog"));bookacti_booking_row_exit_loading_state(a)}})}}},
...
function bookacti_dialog_reschedule_bookings(b){var a=b.all?$j(".bookacti-single-booking, .bookacti-booking-group").closest("tr, .bookacti-booking-row"):$j();b.all||($j.each(b.booking_ids,function(g,f){a=a.add($j('.bookacti-single-booking[data-booking-id="'+f+'"]').closest("tr, .bookacti-booking-row"))}),$j.each(b.booking_group_ids,function(g,f){a=a.add($j('.bookacti-booking-group[data-booking-group-id="'+f+'"]').closest("tr, .bookacti-booking-row"))}));var e=$j("#bookacti-booking-system-reschedule.bookacti-booking-system"),
...
h.form_data.append("action","bookactiGetRescheduleBookingSystemData");h.form_data.append("booking_selection",JSON.stringify(b));h.form_data.append("user_auth_key","undefined"!==typeof user_auth_key?user_auth_key:"");h.form_data.append("is_admin",bookacti_localized.is_admin?1:0);$j("body").trigger("bookacti_booking_action_data",[h,b,"get_reschedule_booking_system_data"]);bookacti_booking_row_enter_loading_state(a);bookacti_add_loading_html($j("#bookacti-reschedule-booking-dialog"),"prepend");$j.ajax({url:bookacti_localized.ajaxurl,
type:"POST",data:h.form_data,dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(g){bookacti_remove_loading_html($j("#bookacti-reschedule-booking-dialog"));if("success"===g.status){d=g.quantity;e.closest("form").find("input.bookacti-quantity").val(d);var f=e.attr("id");bookacti.booking_system[f]=g.booking_system_data;e.trigger("bookacti_before_reschedule_booking_system_loads",[g]);bookacti_reload_booking_system(e)}else"failed"===g.status&&(f="undefined"!==typeof g.message?g.message:
bookacti_localized.error,$j("#bookacti-reschedule-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+f+"</li></ul></div>"),console.log(f),console.log(g))},error:function(g){bookacti_remove_loading_html($j("#bookacti-reschedule-booking-dialog"));$j("#bookacti-reschedule-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>");console.log("AJAX "+bookacti_localized.error);
console.log(g)},complete:function(){$j("#bookacti-reschedule-booking-dialog > .bookacti-notices").show();bookacti_booking_row_exit_loading_state(a)}});$j("#bookacti-reschedule-booking-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_reschedule,"class":"bookacti-dialog-delete-button",click:function(){if(bookacti_validate_picked_events(e,d)){$j("#bookacti-reschedule-booking-dialog > .bookacti-notices").remove();var g=!1,f=bookacti.booking_system[c].picked_events;$j.each(f,
function(l,p){if(0<parseInt(p.group_id))return g=!0,!1});if(!g){var k=1;bookacti_localized.is_admin&&$j("#bookacti-send-notifications-on-reschedule").length&&(k=$j("#bookacti-send-notifications-on-reschedule").prop("checked")?1:0);var n=[];a.first().find("td").each(function(){var l=$j(this).data("column-id");l&&n.push(l)});var m={form_data:new FormData($j("#bookacti-reschedule-booking-form").get(0))};m.form_data.append("action","bookactiRescheduleBookings");m.form_data.append("booking_selection",
JSON.stringify(b));m.form_data.append("picked_events",JSON.stringify(f));m.form_data.append("columns",JSON.stringify(n));m.form_data.append("is_admin",bookacti_localized.is_admin?1:0);m.form_data.append("send_notifications",k);m.form_data.append("user_auth_key","undefined"!==typeof user_auth_key?user_auth_key:"");m.form_data.append("nonce",bookacti_localized.nonce_reschedule_booking);$j("body").trigger("bookacti_booking_action_data",[m,b,"reschedule"]);bookacti_booking_row_enter_loading_state(a);
...
q=(q=q?'.bookacti-single-booking[data-booking-id="'+q+'"]':r?'.bookacti-booking-group[data-booking-group-id="'+r+'"]':"")?p.find(q).addBack(q).closest("tr"):$j();q.length&&$j(this).replaceWith(q);r&&$j('.bookacti-gouped-booking[data-booking-group-id="'+r+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}a.remove();$j("body").trigger("bookacti_bookings_rescheduled",[l,b])}else if("failed"===l.status){var t="undefined"!==typeof l.message?l.message:bookacti_localized.error;$j("#bookacti-reschedule-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
t+"</li></ul></div>");console.log(t);console.log(l)}},error:function(l){$j("#bookacti-reschedule-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>");console.log("AJAX "+bookacti_localized.error);console.log(l)},complete:function(){$j("#bookacti-reschedule-booking-dialog > .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-reschedule-booking-dialog"));bookacti_booking_row_exit_loading_state(a);
...
processData:!1,success:function(d){if("success"===d.status)$j("#bookacti-delete-booking-dialog").dialog("close"),a.animate({opacity:0},function(){a.children("td, th").animate({padding:0}).wrapInner("<div></div>").children().slideUp(function(){a.remove()})}),$j.each(b.booking_group_ids,function(g,f){$j('.bookacti-gouped-booking[data-booking-group-id="'+f+'"]').remove()}),$j("body").trigger("bookacti_booking_deleted",[d,b]),b.all&&window.location.reload();else if("failed"===d.status){var h="undefined"!==
