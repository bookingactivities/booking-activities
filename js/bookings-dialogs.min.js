...
k+'"]':"")?h.find(g).addBack(g).closest("tr"):$j();g.length&&$j(this).replaceWith(g);k&&$j('.bookacti-gouped-booking[data-booking-group-id="'+k+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}a.remove();$j("body").trigger("bookacti_bookings_cancelled",[d,b]);d.allow_refund&&bookacti_dialog_refund_bookings(b)}else if("failed"===d.status){var f="undefined"!==typeof d.message?d.message:bookacti_localized.error;$j("#bookacti-cancel-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
...
m+'"]':"")?g.find(n).addBack(n).closest("tr"):$j();n.length&&$j(this).replaceWith(n);m&&$j('.bookacti-gouped-booking[data-booking-group-id="'+m+'"]').remove()});bookacti_refresh_list_table_hidden_columns();bookacti_init_tooltip()}a.remove();$j("body").trigger("bookacti_bookings_quantity_changed",[f,b,c]);$j("#bookacti-booking-system-bookings-page").length&&bookacti_refresh_booking_numbers($j("#bookacti-booking-system-bookings-page"));f.rows||window.location.reload()}else if("failed"===f.status){var k=
...
complete:function(){$j("#bookacti-change-booking-quantity-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-change-booking-quantity-dialog"));bookacti_booking_row_exit_loading_state(a)}})}}},{text:bookacti_localized.dialog_button_cancel,click:function(){$j(this).dialog("close")}}]);$j("#bookacti-change-booking-quantity-dialog").dialog("open")}
...
q=(q=q?'.bookacti-single-booking[data-booking-id="'+q+'"]':r?'.bookacti-booking-group[data-booking-group-id="'+r+'"]':"")?p.find(q).addBack(q).closest("tr"):$j();q.length&&$j(this).replaceWith(q);r&&$j('.bookacti-gouped-booking[data-booking-group-id="'+r+'"]').remove()});bookacti_refresh_list_table_hidden_columns();bookacti_init_tooltip()}a.remove();$j("#bookacti-booking-system-bookings-page").length&&(bookacti_booking_method_refetch_events($j("#bookacti-booking-system-bookings-page")),bookacti_refresh_booking_numbers($j("#bookacti-booking-system-bookings-page")));
