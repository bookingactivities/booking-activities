...
function bookacti_dialog_update_bookings_calendar_settings(){$j("#bookacti-bookings-calendar-settings-dialog .bookacti-notices").remove();$j("#bookacti-bookings-calendar-settings-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_ok,click:function(){$j("#bookacti-bookings-calendar-settings-dialog .bookacti-notices").remove();var b=$j("#bookacti-bookings-calendar-settings-form").serializeObject();$j("body").trigger("bookacti_bookings_calendar_settings_data",[b]);bookacti_add_loading_html($j("#bookacti-bookings-calendar-settings-dialog"));
