...
[a,b]);var f=$j("#bookacti-booking-system-bookings-page");bookacti_reload_booking_system(f,!0);$j("#bookacti-submit-filter-button").attr("data-ajax",b.calendar_settings.ajax).data("ajax",b.calendar_settings.ajax);$j("#bookacti-bookings-calendar-settings-dialog").dialog("close")}else if("failed"===b.status){f="undefined"!==typeof b.message?b.message:"";if(!f){f+="Error while trying to update calendar settings";var c="undefined"!==typeof b.error?b.error:"";c&&(f+=" ("+c+")")}$j("#bookacti-bookings-calendar-settings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
f+"</li></ul></div>");console.log(f);console.log(b)}},error:function(b){$j("#bookacti-bookings-calendar-settings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX error while trying to update calendar settings</li></ul></div>');console.log("AJAX error while trying to update calendar settings");console.log(b)},complete:function(){$j("#bookacti-bookings-calendar-settings-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-bookings-calendar-settings-dialog"))}})}},
...
var h=[];c.first().find("td").each(function(){var d=$j(this).data("column-id");d&&h.push(d)});var e={action:f,booking_id:a,context:bookacti_localized.is_admin?"admin_booking_list":"user_booking_list",columns:h,user_auth_key:"undefined"!==typeof user_auth_key?user_auth_key:"",nonce:bookacti_localized.nonce_cancel_booking};c.first().trigger("bookacti_booking_action_data",[e,a,b,"cancel"]);bookacti_add_loading_html($j("#bookacti-cancel-booking-dialog"));bookacti_booking_row_enter_loading_state(g);$j.ajax({url:bookacti_localized.ajaxurl,
type:"POST",data:e,dataType:"json",success:function(d){if("success"===d.status)d.row&&(c.last().after(d.row),c.remove(),bookacti_refresh_list_table_hidden_columns()),$j("#bookacti-cancel-booking-dialog").dialog("close"),d.allow_refund&&bookacti_dialog_refund_bookings({booking_ids:"group"===b?[]:[a],booking_group_ids:"group"===b?[a]:[],all:0}),$j("body").trigger("bookacti_booking_cancelled_by_user",[a,b]);else if("failed"===d.status){var k="undefined"!==typeof d.message?d.message:bookacti_localized.error;
$j("#bookacti-cancel-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+k+"</li></ul></div>");console.log(k);console.log(d)}},error:function(d){$j("#bookacti-cancel-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>");console.log("AJAX "+bookacti_localized.error);console.log(d)},complete:function(){$j("#bookacti-cancel-booking-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-cancel-booking-dialog"));
...
a.filters=a.all?bookacti_get_booking_list_filters():{};var f={form_data:new FormData($j("#bookacti-refund-booking-form").get(0))};f.form_data.append("action","bookactiGetBookingsRefundActionsHTML");f.form_data.append("booking_selection",JSON.stringify(a));f.form_data.append("is_admin",bookacti_localized.is_admin?1:0);$j("body").trigger("bookacti_booking_action_data",[f,a,"get_refund_actions"]);bookacti_booking_row_enter_loading_state(b);bookacti_add_loading_html($j("#bookacti-refund-booking-dialog"));
...
a.filters=a.all?bookacti_get_booking_list_filters():{};var e={form_data:new FormData($j("#bookacti-refund-booking-form").get(0))};e.form_data.append("action","bookactiRefundBookings");e.form_data.append("booking_selection",JSON.stringify(a));e.form_data.append("columns",JSON.stringify(h));e.form_data.append("is_admin",bookacti_localized.is_admin?1:0);e.form_data.append("user_auth_key","undefined"!==typeof user_auth_key?user_auth_key:"");$j("body").trigger("bookacti_booking_action_data",[e,a,"refund"]);
bookacti_booking_row_enter_loading_state(b);bookacti_add_loading_html($j("#bookacti-refund-booking-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:e.form_data,dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(d){if("success"===d.status){$j("#bookacti-refund-booking-dialog").dialog("close");if(d.rows){var k=$j(d.rows);b.each(function(){var m=$j(this).find(".bookacti-single-booking").addBack(".bookacti-single-booking").data("booking-id"),n=$j(this).find(".bookacti-booking-group").addBack(".bookacti-booking-group").data("booking-group-id");
m=(m=m?'.bookacti-single-booking[data-booking-id="'+m+'"]':n?'.bookacti-booking-group[data-booking-group-id="'+n+'"]':"")?k.find(m).addBack(m).closest("tr"):$j();m.length&&$j(this).replaceWith(m);n&&$j('.bookacti-gouped-booking[data-booking-group-id="'+n+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}b.remove();d.message&&bookacti_dialog_refund_confirmation(d.message);$j("body").trigger("bookacti_booking_refunded",[d,a]);d.rows||window.location.reload()}else if("failed"===d.status){var l=
"undefined"!==typeof d.message?d.message:bookacti_localized.error;$j("#bookacti-refund-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+l+"</li></ul></div>");console.log(l);console.log(d)}},error:function(d){console.log("AJAX "+bookacti_localized.error);console.log(d)},complete:function(){$j("#bookacti-refund-booking-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-refund-booking-dialog"));bookacti_booking_row_exit_loading_state(b)}})}}},
...
function bookacti_dialog_change_bookings_status(a){var b=a.all?$j(".bookacti-single-booking, .bookacti-booking-group").closest("tr, .bookacti-booking-row"):$j();a.all||($j.each(a.booking_ids,function(g,h){b=b.add($j('.bookacti-single-booking[data-booking-id="'+h+'"]').closest("tr, .bookacti-booking-row"))}),$j.each(a.booking_group_ids,function(g,h){b=b.add($j('.bookacti-booking-group[data-booking-group-id="'+h+'"]').closest("tr, .bookacti-booking-row"))}));var f=1===b.length?b.find(".bookacti-booking-status").data("booking-status"):
"",c=1===b.length?b.find(".bookacti-payment-status").data("payment-status"):"";$j("select#bookacti-select-booking-status").val(f);$j("select#bookacti-select-payment-status").val(c);$j("#bookacti-send-notifications-on-status-change").prop("checked",!1);$j("body").trigger("bookacti_booking_action_dialog_opened",[a,"change_booking_status"]);$j("#bookacti-change-booking-status-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_ok,click:function(){var g=$j("select#bookacti-select-booking-status").val(),
h=$j("select#bookacti-select-payment-status").val();if((g||h)&&(g!==f||h!==c)){$j("#bookacti-change-booking-status-dialog .bookacti-notices").remove();var e=[];b.first().find("td").each(function(){var k=$j(this).data("column-id");k&&e.push(k)});a.filters=a.all?bookacti_get_booking_list_filters():{};var d={form_data:new FormData($j("#bookacti-change-booking-status-form").get(0))};d.form_data.append("action","bookactiChangeBookingsStatus");d.form_data.append("booking_selection",JSON.stringify(a));d.form_data.append("columns",
JSON.stringify(e));d.form_data.append("is_admin",bookacti_localized.is_admin?1:0);$j("body").trigger("bookacti_booking_action_data",[d,a,"change_booking_status"]);bookacti_booking_row_enter_loading_state(b);bookacti_add_loading_html($j("#bookacti-change-booking-status-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:d.form_data,dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(k){if("success"===k.status){$j("#bookacti-change-booking-status-dialog").dialog("close");
if(k.rows){var l=$j(k.rows);b.each(function(){var n=$j(this).find(".bookacti-single-booking").addBack(".bookacti-single-booking").data("booking-id"),p=$j(this).find(".bookacti-booking-group").addBack(".bookacti-booking-group").data("booking-group-id");n=(n=n?'.bookacti-single-booking[data-booking-id="'+n+'"]':p?'.bookacti-booking-group[data-booking-group-id="'+p+'"]':"")?l.find(n).addBack(n).closest("tr"):$j();n.length&&$j(this).replaceWith(n);p&&$j('.bookacti-gouped-booking[data-booking-group-id="'+
p+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}b.remove();g&&$j("body").trigger("bookacti_booking_status_changed",[k,a,g]);h&&$j("body").trigger("bookacti_payment_status_changed",[k,a,h]);k.rows||window.location.reload()}else if("failed"===k.status){var m="undefined"!==typeof k.message?k.message:bookacti_localized.error;$j("#bookacti-change-booking-status-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+m+"</li></ul></div>").show();console.log(m);
console.log(k)}},error:function(k){$j("#bookacti-change-booking-status-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>").show();console.log("AJAX "+bookacti_localized.error);console.log(k)},complete:function(){$j("#bookacti-change-booking-status-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-change-booking-status-dialog"));bookacti_booking_row_exit_loading_state(b)}})}}},{text:bookacti_localized.dialog_button_cancel,
click:function(){$j(this).dialog("close")}}]);$j("#bookacti-change-booking-status-dialog").dialog("open")}
function bookacti_dialog_change_bookings_quantity(a){var b=a.all?$j(".bookacti-single-booking, .bookacti-booking-group").closest("tr, .bookacti-booking-row"):$j();a.all||($j.each(a.booking_ids,function(c,g){b=b.add($j('.bookacti-single-booking[data-booking-id="'+g+'"]').closest("tr, .bookacti-booking-row"))}),$j.each(a.booking_group_ids,function(c,g){b=b.add($j('.bookacti-booking-group[data-booking-group-id="'+g+'"]').closest("tr, .bookacti-booking-row"))}));var f=1===b.length?parseInt(b.find(".column-quantity").text()):
1;$j("#bookacti-new-quantity").val(f);$j("body").trigger("bookacti_booking_action_dialog_opened",[a,"change_quantity"]);$j("#bookacti-change-booking-quantity-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_ok,click:function(){var c=parseInt($j("#bookacti-new-quantity").val());if(c){$j("#bookacti-change-booking-quantity-dialog .bookacti-notices").remove();var g=[];b.first().find("td").each(function(){var e=$j(this).data("column-id");e&&g.push(e)});a.filters=a.all?bookacti_get_booking_list_filters():
...
$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:h.form_data,dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(e){if("success"===e.status){$j("#bookacti-change-booking-quantity-dialog").dialog("close");if(e.rows){var d=$j(e.rows);b.each(function(){var l=$j(this).find(".bookacti-single-booking").addBack(".bookacti-single-booking").data("booking-id"),m=$j(this).find(".bookacti-booking-group").addBack(".bookacti-booking-group").data("booking-group-id");l=(l=l?'.bookacti-single-booking[data-booking-id="'+
l+'"]':m?'.bookacti-booking-group[data-booking-group-id="'+m+'"]':"")?d.find(l).addBack(l).closest("tr"):$j();l.length&&$j(this).replaceWith(l);m&&$j('.bookacti-gouped-booking[data-booking-group-id="'+m+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}b.remove();$j("body").trigger("bookacti_booking_quantity_changed",[e,a,c]);e.rows||window.location.reload()}else if("failed"===e.status){var k="undefined"!==typeof e.message?e.message:bookacti_localized.error;$j("#bookacti-change-booking-quantity-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
k+"</li></ul></div>").show();console.log(k);console.log(e)}},error:function(e){$j("#bookacti-change-booking-quantity-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>").show();console.log("AJAX "+bookacti_localized.error);console.log(e)},complete:function(){$j("#bookacti-change-booking-quantity-dialog .bookacti-notices").show();bookacti_remove_loading_html($j("#bookacti-change-booking-quantity-dialog"));bookacti_booking_row_exit_loading_state(b)}})}}},
...
function bookacti_dialog_reschedule_booking(a){var b=$j('.bookacti-reschedule-booking[data-booking-id="'+a+'"]').closest("tr"),f=$j('.bookacti-reschedule-booking[data-booking-id="'+a+'"]').closest("tr, .bookacti-booking-row"),c=$j("#bookacti-booking-system-reschedule.bookacti-booking-system"),g=c.attr("id"),h=0;bookacti_localized.is_admin&&$j("#bookacti-send-notifications-on-reschedule").prop("checked",!1);c.empty();bookacti_clear_booking_system_displayed_info(c);bookacti_localized.is_admin&&"undefined"!==
typeof bookacti_empty_all_dialog_forms||$j("#bookacti-reschedule-booking-dialog").dialog({beforeClose:function(){$j("#bookacti-reschedule-booking-dialog .bookacti-notices").not("#bookacti-reschedule-booking-dialog .bookacti-booking-system-container .bookacti-notices").remove();$j("#bookacti-reschedule-booking-dialog .bookacti-booking-system-container .bookacti-notices").empty().hide()}});b.first().trigger("bookacti_booking_action_dialog_opened",[a,"single","reschedule"]);bookacti_booking_row_enter_loading_state(f);
$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:{action:"bookactiGetRescheduleBookingSystemData",booking_id:a,user_auth_key:"undefined"!==typeof user_auth_key?user_auth_key:"",is_admin:bookacti_localized.is_admin?1:0},dataType:"json",success:function(e){if("success"===e.status){var d=c.attr("id");h=e.booking_system_data.rescheduled_booking_data.quantity;c.closest("form").find("input.bookacti-quantity").val(h);bookacti.booking_system[d]=e.booking_system_data;c.trigger("bookacti_before_reschedule_booking_system_loads",
[e]);bookacti_reload_booking_system(c)}else"failed"===e.status&&(d="undefined"!==typeof e.message?e.message:bookacti_localized.error,c.siblings(".bookacti-notices").html("<ul class='bookacti-error-list'><li>"+d+"</li></ul>").show(),console.log(d),console.log(e))},error:function(e){c.siblings(".bookacti-notices").html('<ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul>").show();console.log("AJAX "+bookacti_localized.error);console.log(e)},complete:function(){bookacti_booking_row_exit_loading_state(f)}});
$j("#bookacti-reschedule-booking-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_reschedule,"class":"bookacti-dialog-delete-button",click:function(){if(bookacti_validate_picked_events(c,h)){var e=bookacti.booking_system[g].picked_events;if(!(0<parseInt(e[0].group_id))){var d=1;bookacti_localized.is_admin&&$j("#bookacti-send-notifications-on-reschedule").length&&(d=$j("#bookacti-send-notifications-on-reschedule").prop("checked")?1:0);var k=[];b.first().find("td").each(function(){var l=
$j(this).data("column-id");l&&k.push(l)});e={action:"bookactiRescheduleBooking",booking_id:a,picked_events:e,columns:k,context:bookacti_localized.is_admin?"admin_booking_list":"user_booking_list",is_admin:bookacti_localized.is_admin?1:0,send_notifications:d,user_auth_key:"undefined"!==typeof user_auth_key?user_auth_key:"",nonce:bookacti_localized.nonce_reschedule_booking};b.first().trigger("bookacti_booking_action_data",[e,a,"single","reschedule"]);bookacti_booking_row_enter_loading_state(f);bookacti_start_loading_booking_system(c);
bookacti_add_loading_html($j("#bookacti-reschedule-booking-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:e,dataType:"json",success:function(l){if("success"===l.status)$j("#bookacti-reschedule-booking-dialog").dialog("close"),l.row&&(b.last().after(l.row),b.remove(),bookacti_refresh_list_table_hidden_columns()),$j("body").trigger("bookacti_booking_rescheduled",[l]);else{var m="undefined"!==typeof l.message?l.message:bookacti_localized.error;c.siblings(".bookacti-notices").html("<ul class='bookacti-error-list'><li>"+
m+"</li></ul>").show();console.log(m);console.log(l)}},error:function(l){console.log("AJAX "+bookacti_localized.error);console.log(l)},complete:function(){bookacti_remove_loading_html($j("#bookacti-reschedule-booking-dialog"));bookacti_booking_row_exit_loading_state(f);bookacti_stop_loading_booking_system(c)}})}}}},{text:bookacti_localized.dialog_button_cancel,click:function(){$j(this).dialog("close")}}]);$j("#bookacti-reschedule-booking-dialog").dialog("open")}
function bookacti_dialog_send_bookings_notification(a){var b=a.all?$j(".bookacti-single-booking, .bookacti-booking-group").closest("tr, .bookacti-booking-row"):$j();a.all||($j.each(a.booking_ids,function(f,c){b=b.add($j('.bookacti-single-booking[data-booking-id="'+c+'"]').closest("tr, .bookacti-booking-row"))}),$j.each(a.booking_group_ids,function(f,c){b=b.add($j('.bookacti-booking-group[data-booking-group-id="'+c+'"]').closest("tr, .bookacti-booking-row"))}));$j("body").trigger("bookacti_booking_action_dialog_opened",
[a,"send_notification"]);$j("#bookacti-send-booking-notification-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_send,click:function(){var f=$j("#bookacti-booking-notification-id").val();if(f){$j("#bookacti-send-booking-notification-dialog .bookacti-notices").remove();var c=[];b.first().find("td").each(function(){var h=$j(this).data("column-id");h&&c.push(h)});a.filters=a.all?bookacti_get_booking_list_filters():{};var g={form_data:new FormData($j("#bookacti-send-booking-notification-form").get(0))};
...
a.booking_group_ids.length);$j("body").trigger("bookacti_booking_action_dialog_opened",[a,"delete"]);$j("#bookacti-delete-booking-dialog").dialog("option","buttons",[{text:bookacti_localized.dialog_button_delete,"class":"bookacti-dialog-delete-button",click:function(){$j("#bookacti-delete-booking-dialog .bookacti-notices").remove();var f=[];b.first().find("td").each(function(){var g=$j(this).data("column-id");g&&f.push(g)});a.filters=a.all?bookacti_get_booking_list_filters():{};var c={form_data:new FormData($j("#bookacti-delete-booking-form").get(0))};
c.form_data.append("action","bookactiDeleteBookings");c.form_data.append("booking_selection",JSON.stringify(a));c.form_data.append("columns",JSON.stringify(f));c.form_data.append("is_admin",bookacti_localized.is_admin?1:0);$j("body").trigger("bookacti_booking_action_data",[c,a,"delete"]);bookacti_booking_row_enter_loading_state(b);bookacti_add_loading_html($j("#bookacti-delete-booking-dialog"));$j.ajax({url:bookacti_localized.ajaxurl,type:"POST",data:c.form_data,dataType:"json",cache:!1,contentType:!1,
processData:!1,success:function(g){if("success"===g.status)$j("#bookacti-delete-booking-dialog").dialog("close"),b.animate({opacity:0},function(){b.children("td, th").animate({padding:0}).wrapInner("<div></div>").children().slideUp(function(){b.remove()})}),$j.each(a.booking_group_ids,function(e,d){$j('.bookacti-gouped-booking[data-booking-group-id="'+d+'"]').remove()}),$j("body").trigger("bookacti_booking_deleted",[g,a]),a.all&&window.location.reload();else if("failed"===g.status){var h="undefined"!==
...
type:"POST",data:b,dataType:"json",success:function(f){if("success"===f.status)$j("#bookacti_export_bookings_url_secret").val(f.url),$j("#bookacti-export-bookings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-success-list"><li>'+f.message+"</li></ul></div>").show(),$j("#bookacti-export-bookings-url-container").data("export-type",b.export_type),$j("#bookacti-export-bookings-url-container").show(),$j("#bookacti-form-editor").trigger("bookacti_export_bookings_url",[f]);else if("failed"===
f.status){var c="undefined"!==typeof f.message?f.message:bookacti_localized.error;$j("#bookacti-export-bookings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+c+"</li></ul></div>").show();console.log(c);console.log(f)}},error:function(f){$j("#bookacti-export-bookings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>AJAX '+bookacti_localized.error+"</li></ul></div>").show();console.log("AJAX "+bookacti_localized.error);console.log(f)},
