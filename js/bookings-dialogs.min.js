...
k+'"]':"")?h.find(g).addBack(g).closest("tr, .bookacti-booking-row"):$j();g.length&&$j(this).replaceWith(g);k&&$j('.bookacti-gouped-booking[data-booking-group-id="'+k+'"]').remove()});bookacti_refresh_list_table_hidden_columns()}a.remove();$j("body").trigger("bookacti_bookings_cancelled",[d,b]);d.allow_refund&&bookacti_dialog_refund_bookings(b)}else if("failed"===d.status){var f="undefined"!==typeof d.message?d.message:bookacti_localized.error;$j("#bookacti-cancel-booking-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
...
l+'"]':"")?k.find(m).addBack(m).closest("tr, .bookacti-booking-row"):$j();m.length&&$j(this).replaceWith(m);l&&$j('.bookacti-gouped-booking[data-booking-group-id="'+l+'"]').remove()});bookacti_refresh_list_table_hidden_columns();bookacti_init_tooltip()}a.remove();g.message&&bookacti_dialog_refund_confirmation(g.message);$j("#bookacti-booking-system-bookings-page").length&&bookacti_refresh_booking_numbers($j("#bookacti-booking-system-bookings-page"));$j("body").trigger("bookacti_bookings_refunded",
