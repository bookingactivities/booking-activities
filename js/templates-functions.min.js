...
$j("#bookacti-group-categories").append(c.groups_list);$j("#bookacti-template-add-group-of-events-tuto-select-events").toggle(c.groups_list==="");$j("#bookacti-template-groups-of-events-container .dashicons").toggleClass("bookacti-disabled",bookacti.booking_system["bookacti-template-calendar"].loading_number>0);bookacti.booking_system["bookacti-template-calendar"].selected_events=[];$j("#bookacti-insert-group-of-events").css("visibility","hidden");$j("#bookacti-template-add-first-group-of-events-container").hide();
$j('#bookacti-group-of-events-category-selectbox option[value!="new"]').remove();var g=[];$j("#bookacti-group-categories .bookacti-group-category").each(function(){$j("#bookacti-group-of-events-category-selectbox").append('<option value="'+$j(this).data("group-category-id")+'">'+$j(this).find(".bookacti-group-category-title").attr("title")+"</option>");$j(this).data("visible")==1&&g.push($j(this).data("group-category-id"))});bookacti_make_group_categories_sortable();bookacti_make_groups_of_events_sortable();
