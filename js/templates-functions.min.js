...
group_ids:JSON.stringify(b),nonce:$j("#bookacti-edit-template-nonce").val()},dataType:"json",success:function(c){if("success"===c.status)$j.isEmptyObject(bookacti.booking_system["bookacti-template-calendar"].events)?bookacti.booking_system["bookacti-template-calendar"].events=c.events:bookacti.booking_system["bookacti-template-calendar"].events=bookacti.booking_system["bookacti-template-calendar"].events.concat(c.events),$j.isEmptyObject(bookacti.booking_system["bookacti-template-calendar"].events_data)?
...
!1))}function bookacti_display_activity_tuto_if_no_activity_available(){$j("#bookacti-template-first-activity-container").length&&$j("#bookacti-template-first-activity-container").toggle(0>=$j(".bookacti-activity").length);$j("#bookacti-template-no-activity").length&&$j("#bookacti-template-no-activity").toggle(0>=$j(".bookacti-activity").length)}
