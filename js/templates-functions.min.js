...
1),$j('.bookacti-group-category[data-group-category-id="'+a+'"] .bookacti-groups-of-events-editor-list').slideDown(200,function(){bookacti_set_editor_group_of_events_max_height(a)})):($j('.bookacti-group-category[data-group-category-id="'+a+'"]').attr("data-show-groups",0),$j('.bookacti-group-category[data-group-category-id="'+a+'"]').data("show-groups",0),$j('.bookacti-group-category[data-group-category-id="'+a+'"] .bookacti-groups-of-events-editor-list').slideUp(200,function(){bookacti_set_editor_group_of_events_max_height(a)}))}
function bookacti_set_editor_group_of_events_max_height(a){150<=$j('.bookacti-group-category[data-group-category-id="'+a+'"] .bookacti-groups-of-events-editor-list').outerHeight()?$j('.bookacti-group-category[data-group-category-id="'+a+'"] .bookacti-groups-of-events-editor-list').css("height",150):$j('.bookacti-group-category[data-group-category-id="'+a+'"] .bookacti-groups-of-events-editor-list').css("height","auto");200<$j("#bookacti-group-categories").outerHeight()?$j("#bookacti-group-categories").css("height",
200):$j("#bookacti-group-categories").css("height","auto")}
