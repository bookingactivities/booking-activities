...
function bookacti_get_interval_of_events(b,a){var c=b.attr("id"),f=bookacti.booking_system[c].events_interval,d=bookacti_get_display_period(b);c=parseInt(bookacti_localized.event_load_interval);var e=d.start?moment.utc(d.start):!1;d=d.end?moment.utc(d.end):!1;var g=moment.utc(a.start).clone(),k=moment.utc(a.end).clone();e&&g.isBefore(e)&&(g=e.clone());d&&k.isAfter(d)&&(k=d.clone());var h={},p={start:g.clone(),end:k.clone()};if($j.isEmptyObject(f))h=bookacti_get_new_interval_of_events(b,p);else{var n=
moment.utc(f.start).clone().locale("en");f=moment.utc(f.end).clone().locale("en");if(g.isBefore(n)||k.isAfter(f)){h=n.clone();var l=f.clone(),m=moment.utc(a.start).clone().subtract(1,"days").locale("en");a=moment.utc(a.end).clone().add(1,"days").locale("en");if((g.isBefore(n)&&k.isAfter(f)||k.isBefore(n)||g.isAfter(f))&&m.format("YYYY-MM-DD")+" 23:59:59"!==f.format("YYYY-MM-DD HH:mm:ss")&&a.format("YYYY-MM-DD")+" 00:00:00"!==n.format("YYYY-MM-DD HH:mm:ss"))bookacti_booking_method_clear_events(b),
h=bookacti_get_new_interval_of_events(b,p);else{if(g.isBefore(n)||a.format("YYYY-MM-DD")+" 00:00:00"===n.format("YYYY-MM-DD HH:mm:ss"))h.subtract(c,"days"),g.isBefore(h)&&(h=g.clone()),e&&h.isBefore(e)&&(h=e.clone()),l=moment.utc(n.clone().subtract(1,"days").format("YYYY-MM-DD")+" 23:59:59");else if(k.isAfter(f)||m.format("YYYY-MM-DD")+" 23:59:59"===f.format("YYYY-MM-DD HH:mm:ss"))l.add(c,"days"),k.isAfter(l)&&(l=k.clone()),d&&l.isAfter(d)&&(l=d.clone()),h=moment.utc(f.clone().add(1,"days").format("YYYY-MM-DD")+
...
h){$j.each(h,function(p,n){$j.each(n,function(l,m){if(parseInt(m.id)===f&&m.start===d&&m.end===e)return typeof c[k]==="undefined"&&(c[k]={}),c[k][p]=n,!1;if(g&&parseInt(g))return!1})})});return c}function bookacti_get_event_groups_nb(b){var a=0;$j.each(b,function(c,f){$j.each(f,function(d,e){++a})});return a}
...
var p=typeof a.start!=="undefined"?a.start:"",n=typeof a.end!=="undefined"?a.end:"";d={group_id:c,group_date:f?moment.utc(f).clone().locale("en").format("YYYY-MM-DD"):"",id:d,start:p?moment.utc(p).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"):"",end:n?moment.utc(n).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"):"",title:k,activity_id:parseInt(h)};bookacti.booking_system[g].picked_events.push(d);++e;bookacti.booking_system[g].picked_events.sort(function(l,m){l=moment.utc(l.start);m=moment.utc(m.start);
return l.isBefore(m)?-1:l.isAfter(m)?1:0});b.trigger("bookacti_pick_event",[a,c,f]);return e}
function bookacti_unpick_events(b,a,c,f){$j.isNumeric(a)&&(a={id:parseInt(a),start:"",end:""});c=$j.isNumeric(c)?parseInt(c):0;f=f?f:"";var d=typeof a.groupId!=="undefined"?parseInt(a.groupId):typeof a.id!=="undefined"?parseInt(a.id):0,e=0;if(!c&&!d)return e;var g=b.attr("id"),k=typeof a.start!=="undefined"?a.start:"",h=k?moment.utc(k).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"):"",p=c,n=f?moment.utc(f).clone().locale("en").format("YYYY-MM-DD"):"",l=[];$j.each(bookacti.booking_system[g].picked_events,
function(m,q){if(!q.group_id)return!0;m=q.group_id+"_"+q.group_date;var r=p&&q.group_id==p?1:0,t=n&&q.group_date===n?1:0,v=d&&q.id==d?1:0;q=h&&q.start.substr(0,10)===h.substr(0,10)?1:0;d||!r||n&&!t||l.push(m);p||!v||h&&!q||l.push(m);v&&r&&(n&&!t||h&&!q||l.push(m))});k=$j.grep(bookacti.booking_system[g].picked_events,function(m){var q=m.group_id+"_"+m.group_date,r=d&&m.id==d?1:0;m=h&&m.start.substr(0,10)===h.substr(0,10)?1:0;return $j.inArray(q,l)>=0||r&&!h||r&&m?(++e,!1):!0});bookacti.booking_system[g].picked_events=
...
function bookacti_get_min_and_max_quantity(b){var a=b.attr("id"),c=bookacti.booking_system[a],f=[],d=1,e=999999999,g=999999999,k,h,p,n;$j.each(c.picked_events,function(l,m){h=k=0;p=1;n=!1;if(parseInt(m.group_id)>0){l=m.group_id+""+m.group_date;if($j.inArray(l,f)>-1)return!0;f.push(l);typeof c.groups_data!=="undefined"&&typeof c.groups_data[m.group_id]!=="undefined"&&(l=parseInt(c.groups_data[m.group_id].category_id),typeof c.group_categories_data!=="undefined"&&typeof c.group_categories_data[l]!==
"undefined"&&typeof c.group_categories_data[l].settings!=="undefined"&&(l=c.group_categories_data[l].settings,p=typeof l.min_bookings_per_user==="undefined"?1:l.min_bookings_per_user?parseInt(l.min_bookings_per_user):1,n=typeof l.max_bookings_per_user==="undefined"?!1:l.max_bookings_per_user?parseInt(l.max_bookings_per_user):!1));m.group_date&&typeof c.groups_bookings[m.group_id]!=="undefined"&&typeof c.groups_bookings[m.group_id][m.group_date]!=="undefined"&&(k=parseInt(c.groups_bookings[m.group_id][m.group_date].availability),
p||n)&&(h=parseInt(c.groups_bookings[m.group_id][m.group_date].current_user_bookings))}else typeof c.events_data!=="undefined"&&typeof c.events_data[m.id]!=="undefined"&&(k=bookacti_get_event_availability(b,m),l=parseInt(c.events_data[m.id].activity_id),typeof c.activities_data!=="undefined"&&typeof c.activities_data[l]!=="undefined"&&typeof c.activities_data[l].settings!=="undefined"&&(l=c.activities_data[l].settings,p=typeof l.min_bookings_per_user==="undefined"?1:l.min_bookings_per_user?parseInt(l.min_bookings_per_user):
1,n=typeof l.max_bookings_per_user==="undefined"?!1:l.max_bookings_per_user?parseInt(l.max_bookings_per_user):!1,p||n))&&(l=moment.utc(m.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"),typeof c.bookings[m.id]!=="undefined"&&typeof c.bookings[m.id][l]!=="undefined"&&(h=parseInt(c.bookings[m.id][l].current_user_bookings)));n=n&&n!=0&&n-h<k?Math.max(n-h,0):Math.max(k,0);p=p&&p!=0&&p>1&&h<p?Math.max(p-h,0):1;p>d&&(d=p);n&&n<e&&(e=n);k<g&&(g=k)});a={avail:g,min:d,max:e};b.trigger("bookacti_min_and_max_quantity",
[a]);return a}
...
function bookacti_is_event_available(b,a){var c=b.attr("id"),f=bookacti.booking_system[c],d=f.past_events_bookable,e=typeof a.groupId!=="undefined"?parseInt(a.groupId):parseInt(a.id),g=moment.utc(a.start).clone().locale("en"),k=moment.utc(a.end).clone().locale("en"),h=moment.utc(bookacti_localized.current_time),p=bookacti_get_event_availability(b,a),n=bookacti_get_availability_period(b),l=!1,m=!0;typeof a.is_available!=="undefined"&&(a.is_available||(m=!1));typeof a.extendedProps!=="undefined"&&typeof a.extendedProps.is_available!==
"undefined"&&(a.extendedProps.is_available||(m=!1));if(p<=0)return!1;b=bookacti_get_event_groups(b,a);b=bookacti_get_event_groups_nb(b)>0;a=f.groups_single_events;if(c==="bookacti-booking-system-reschedule"){if(b&&!a)return!1;if(c=typeof f.rescheduled_bookings_data!=="undefined"?f.rescheduled_bookings_data:[]){var q=0,r=!1,t=1;$j.each(c,function(v,u){u?.event_id==e&&u?.event_start===g.format("YYYY-MM-DD HH:mm:ss")&&u?.event_end===k.format("YYYY-MM-DD HH:mm:ss")&&(r=!0);typeof u.quantity!=="undefined"&&
parseInt(u.quantity)>t&&(t=parseInt(u.quantity));++q});if(r&&q===1||t>p)return!1}}if((!b||b&&a)&&m&&typeof f.events_data[e]!=="undefined"){m=!1;d||!g.isBefore(h)||bookacti_localized.started_events_bookable&&k.isAfter(h)||(m=!0);d=!1;if(n.start&&g.isBefore(moment.utc(n.start))&&g.isAfter(h)||n.end&&g.isAfter(moment.utc(n.end)))d=!0;m||d||(h=parseInt(f.events_data[e].activity_id),b=f.activities_data[h].settings,d=n=h=!0,a=g.format("YYYY-MM-DD HH:mm:ss"),typeof f.bookings[e]!=="undefined"&&typeof f.bookings[e][a]!==
"undefined"&&(m=typeof b.min_bookings_per_user==="undefined"?0:b.min_bookings_per_user?parseInt(b.min_bookings_per_user):0,c=typeof b.max_bookings_per_user==="undefined"?0:b.max_bookings_per_user?parseInt(b.max_bookings_per_user):0,b=typeof b.max_users_per_event==="undefined"?0:b.max_users_per_event?parseInt(b.max_users_per_event):0,m||c||b)&&(f=f.bookings[e][a],a=parseInt(f.current_user_bookings),b&&a===0&&f.distinct_users>=b&&(d=!1),c&&a>=c&&(n=!1),m&&m>p+a&&(h=!1)),h&&n&&d&&(l=!0))}return l}
...
function bookacti_is_group_of_events_available(b,a,c){var f=b.attr("id"),d=bookacti.booking_system[f],e=d?.past_events_bookable,g=d?.groups_events?.[a]?.[c],k=bookacti_get_availability_period(b),h;var p=h=f=b=0;typeof d.groups_bookings[a]!=="undefined"&&typeof d.groups_bookings[a][c]!=="undefined"&&(p=d.groups_bookings[a][c].is_available,h=d.groups_bookings[a][c].availability,f=d.groups_bookings[a][c].current_user_bookings,b=d.groups_bookings[a][c].distinct_users);c=p&&h>0;a=(a=d?.groups_data?.[a])?
parseInt(a.category_id):0;d=d?.group_categories_data?.[a]?.settings;a=parseInt(bookacti_localized.started_groups_bookable);typeof d.started_groups_bookable!=="undefined"&&$j.inArray(d.started_groups_bookable,[0,1,"0","1",!0,!1])>=0&&(a=$j.isNumeric(d.started_groups_bookable)?parseInt(d.started_groups_bookable):d.started_groups_bookable?1:0);p=moment.utc(bookacti_localized.current_time);var n=moment.utc(g[0].start).clone();g=moment.utc(g[g.length-1].end).clone();e||!n.isBefore(p)||a&&g.isAfter(p)||
(c=!1);if(k.start&&n.isBefore(moment.utc(k.start))&&n.isAfter(p)||k.end&&n.isAfter(moment.utc(k.end)))c=!1;if(c){e=c=!1;k=g=!0;(typeof d.min_bookings_per_user==="undefined"?0:d.min_bookings_per_user?parseInt(d.min_bookings_per_user):0)<=h&&h>0&&(e=!0);h=typeof d.max_users_per_event==="undefined"?0:d.max_users_per_event?parseInt(d.max_users_per_event):0;if((d=typeof d.max_bookings_per_user==="undefined"?0:d.max_bookings_per_user?parseInt(d.max_bookings_per_user):0)||h)f=parseInt(f),h&&f===0&&parseInt(b)>=
h&&(k=!1),d&&f>=d&&(g=!1);e&&g&&k&&(c=!0)}return c}function bookacti_get_bookings_number_for_a_single_grouped_event(b,a,c){c=$j.isEmptyObject(c)?bookacti_get_event_groups(b,a):c;var f=b.attr("id"),d=bookacti.booking_system[f];b=bookacti_get_event_number_of_bookings(b,a);var e=0;$j.each(c,function(g,k){$j.each(k,function(h,p){typeof d.groups_bookings[g]!=="undefined"&&typeof d.groups_bookings[g][h]!=="undefined"&&(e+=d.groups_bookings[g][h].quantity)})});return b-e}
...
parseInt(p);var n=d===1?bookacti.booking_system[c].activities_data?.[k]?.settings?.unit_name_singular:bookacti.booking_system[c].activities_data?.[k]?.settings?.unit_name_plural;g=d===1?bookacti_localized.avail:bookacti_localized.avails;h||=0;n&&p||(n="");var l=(d<h?"bookacti-booked":"bookacti-not-booked")+(d<=0?" bookacti-full":"");var m="",q=h?parseInt(d/h*100):0;h=parseInt(bookacti.booking_system[c].hide_availability);var r=parseInt(bookacti_localized.hide_availability_fixed);q=h<100&&q>h;var t=
r>0&&d>r;if(!f){if(r<=0&&q||h>=100&&t||q&&t)e="",m="bookacti-hide-availability";f=bookacti_is_event_available(b,a);h=bookacti_is_event_in_available_group(b,a);!f&&!h&&d>0&&(l+=" bookacti-not-bookable",bookacti_localized.not_bookable!=="{current}"&&(bookacti_localized.not_bookable?(n=e="",g=bookacti_localized.not_bookable):(e=0,n=bookacti.booking_system[c].activities_data?.[k]?.settings?.unit_name_plural,g=bookacti_localized.avails,n&&p||(n=""))))}k="";n&&(k="bookacti-has-unit-name");c=$j("<div></div>",
{"class":"bookacti-availability-container "+m});l=$j("<div></div>",{"class":"bookacti-available-places "+l});e=$j("<span></span>",{"class":"bookacti-available-places-number",html:e});n=$j("<span></span>",{"class":"bookacti-available-places-unit-name "+k,html:n});g=$j("<span></span>",{"class":"bookacti-available-places-avail-particle",html:g});l.append(e);l.append(n);l.append(g);c.append(l);b.trigger("bookacti_event_availability_div",[c,a,d]);return c}
