...
f.booking_system_data,"undefined"!==typeof e.rescheduled_bookings_data&&(bookacti.booking_system[c].rescheduled_bookings_data=$j.extend(!0,{},e.rescheduled_bookings_data)),"undefined"!==typeof e.templates_per_activities&&(bookacti.booking_system[c].templates_per_activities=$j.extend(!0,{},e.templates_per_activities)),b.append(f.html_elements),bookacti_booking_method_set_up(b),bookacti_fill_booking_system_fields(b),bookacti_fill_picked_events_list(b),b.trigger("bookacti_booking_system_reloaded",[f,
e,d])):(console.log("undefined"!==typeof f.message?f.message:bookacti_localized.error),console.log(f))},error:function(f){console.log("AJAX "+bookacti_localized.error);console.log(f)},complete:function(){bookacti_stop_loading_booking_system(b)}})}
...
function bookacti_event_click(b,a){var c=b.attr("id"),e=bookacti.booking_system[c].multiple_bookings;if(!bookacti_unpick_events(b,a)){var d={},f=[],g=0;"bookacti-booking-system-reschedule"!==c&&(d=bookacti_get_event_groups(b,a),g=bookacti_get_event_groups_nb(d),f=Object.keys(d));var k=!1;1<g||1===g&&bookacti.booking_system[c].groups_single_events?(k=!0,bookacti_dialog_choose_group_of_events(b,d,a)):(f=(c=f.length?f[0]:0)?Object.keys(d[c]):[],f=f.length?f[0]:"",e||bookacti_unpick_all_events(b),bookacti_pick_events(b,
a,c,f),c&&b.trigger("bookacti_group_of_events_chosen",[c,f,a]));b.trigger("bookacti_event_click",[a,d,k])}}
