...
bookacti.booking_system[c].groups_data[d.group_id].title+"</span>"),g=$j("<li></li>",{html:h+'<ul class="bookacti-picked-group-of-events-list">'+g[0].outerHTML+"</ul>"}),g.data("group-id",d.group_id).attr("data-group-id",d.group_id),g.data("group-date",d.group_date).attr("data-group-date",d.group_date),a[f]=$j.extend(!0,{},d),a[f].list_element=g):(a[f].end=d.end,a[f].list_element.find("ul").append(g)):(a[f]=$j.extend(!0,{},d),a[f].list_element=g)});b.trigger("bookacti_picked_events_list_items",[a]);
return a}
