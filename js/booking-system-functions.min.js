...
(t=!0);typeof v.quantity!=="undefined"&&parseInt(v.quantity)>u&&(u=parseInt(v.quantity));++r});if(t&&r===1||u>m)return!1}}(!c||c&&a)&&q&&typeof f.events_data[g]!=="undefined"&&(q=!1,d&&(e||!k.isBefore(p)||bookacti_localized.started_events_bookable&&l.isAfter(p)||(q=!0),e||(h.start&&k.isBefore(moment.utc(h.start))&&(q=!0),h.end&&l.isAfter(moment.utc(h.end))&&(q=!0))),!q)&&(d=parseInt(f.events_data[g].activity_id),h=f.activities_data[d].settings,d=max_qty_ok=max_users_ok=!0,q=k.format("YYYY-MM-DD HH:mm:ss"),
typeof f.bookings[g]!=="undefined"&&typeof f.bookings[g][q]!=="undefined"&&(e=typeof h.min_bookings_per_user==="undefined"?0:h.min_bookings_per_user?parseInt(h.min_bookings_per_user):0,p=typeof h.max_bookings_per_user==="undefined"?0:h.max_bookings_per_user?parseInt(h.max_bookings_per_user):0,h=typeof h.max_users_per_event==="undefined"?0:h.max_users_per_event?parseInt(h.max_users_per_event):0,e||p||h)&&(f=f.bookings[g][q],q=parseInt(f.current_user_bookings),h&&q===0&&f.distinct_users>=h&&(max_users_ok=
!1),p&&q>=p&&(max_qty_ok=!1),e&&e>m+q&&(d=!1)),d&&max_qty_ok&&max_users_ok&&(n=!0));return n}function bookacti_is_event_in_available_group(c,a){a=bookacti_get_event_groups(c,a);var b=!1;bookacti_get_event_groups_nb(a)>0&&$j.each(a,function(f,d){$j.each(d,function(e,g){if(b=bookacti_is_group_of_events_available(c,f,e))return!1});if(b)return!1});return b}
...
(b=!1);e||(k.start&&(!m.isBefore(moment.utc(k.start))||a&&g.isAfter(moment.utc(k.start))||(b=!1)),k.end&&m.isAfter(moment.utc(k.end))&&(b=!1));if(b){e=b=!1;(typeof d.min_bookings_per_user==="undefined"?0:d.min_bookings_per_user?parseInt(d.min_bookings_per_user):0)<=l&&l>0&&(e=!0);l=typeof d.max_users_per_event==="undefined"?0:d.max_users_per_event?parseInt(d.max_users_per_event):0;g=typeof d.max_bookings_per_user==="undefined"?0:d.max_bookings_per_user?parseInt(d.max_bookings_per_user):0;k=max_users_ok=
!0;if(g||l)f=parseInt(f),l&&f===0&&parseInt(c)>=l&&(max_users_ok=!1),g&&f>=g&&(k=!1);e&&k&&max_users_ok&&(b=!0)}return b}
