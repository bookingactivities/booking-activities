...
(a.extendedProps.is_available||(q=!1));if(0>=p)return!1;b=bookacti_get_event_groups(b,a);a=0<bookacti_get_event_groups_nb(b);var u=e.groups_single_events;if("bookacti-booking-system-reschedule"===c){if(a&&!u)return!1;c="undefined"!==typeof e.rescheduled_booking_data?e.rescheduled_booking_data:[];if("undefined"!==typeof c.event_id&&"undefined"!==typeof c.event_start&&"undefined"!==typeof c.event_end&&c.event_id==g&&c.event_start===k.format("YYYY-MM-DD HH:mm:ss")&&c.event_end===l.format("YYYY-MM-DD HH:mm:ss")||
