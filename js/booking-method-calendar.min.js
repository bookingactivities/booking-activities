$j(document).ready(function(){$j("body").on("bookacti_booking_method_set_up",".bookacti-booking-system",function(a,d,c){"calendar"===d&&$j(this).find(".bookacti-calendar").length&&bookacti_set_calendar_up($j(this),c)});$j("body").on("bookacti_booking_method_update_availability_period",".bookacti-booking-system",function(a,d,c){"calendar"===d&&$j(this).find(".bookacti-calendar").length&&(a=$j(this).attr("id"),"undefined"!==typeof bookacti.fc_calendar[a]&&(c={start:c.start?moment.utc(c.start.substr(0,
10)).format("YYYY-MM-DD"):null,end:c.end?moment.utc(c.end.substr(0,10)).add(1,"days").format("YYYY-MM-DD"):null},bookacti.fc_calendar[a].setOption("validRange",c)))});$j("body").on("bookacti_booking_method_display_events",".bookacti-booking-system",function(a,d,c){"calendar"===d&&$j(this).find(".bookacti-calendar").length&&bookacti_fc_add_events($j(this),c)});$j("body").on("bookacti_refetch_events",".bookacti-booking-system",function(a,d){"calendar"===d&&(a=$j(this).attr("id"),"undefined"!==typeof bookacti.fc_calendar[a]&&
bookacti.fc_calendar[a].removeAllEvents(),bookacti_get_booking_system_data_by_interval($j(this)))});$j("body").on("bookacti_rerender_events",".bookacti-booking-system",function(a,d){"calendar"===d&&(a=$j(this).attr("id"),"undefined"!==typeof bookacti.fc_calendar[a]&&bookacti.fc_calendar[a].render())});$j("body").on("bookacti_clear_events",".bookacti-booking-system",function(a,d){"calendar"===d&&(a=$j(this).attr("id"),"undefined"!==typeof bookacti.fc_calendar[a]&&bookacti.fc_calendar[a].removeAllEvents())});
$j("body").on("bookacti_booking_system_reloaded",".bookacti-booking-system",function(a,d){$j(this).find(".bookacti-calendar").length&&bookacti_refresh_picked_events_on_calendar($j(this))});$j("body").on("bookacti_start_loading",".bookacti-booking-system, .bookacti-booking-system-editor",function(a,d){"calendar"===d&&(a=$j(this),a.find(".bookacti-calendar.fc").length?(d=a.attr("id"),0!==bookacti.booking_system[d].loading_number&&a.find(".bookacti-loading-overlay").length||(bookacti_remove_loading_html(a),
bookacti_enter_calendar_loading_state(a.find(".bookacti-calendar")))):a.find(".bookacti-loading-container").length||bookacti_add_loading_html(a))});$j("body").on("bookacti_exit_loading_state",".bookacti-booking-system, .bookacti-booking-system-editor",function(a,d){"calendar"===d&&(bookacti_remove_loading_html($j(this)),$j(this).find(".bookacti-calendar").length&&bookacti_exit_calendar_loading_state($j(this).find(".bookacti-calendar")))});$j("body").on("change",".bookacti-go-to-datepicker",function(){var a=
$j(this).prev(".fc-goTo-button");a.find(".bookacti-spinner").length||a.append('<span class="bookacti-spinner"></span>');"undefined"!==typeof bookacti_go_to_date&&bookacti_go_to_date&&clearTimeout(bookacti_go_to_date);var d=$j(this).val(),c=$j(this).closest(".bookacti-booking-system").length?$j(this).closest(".bookacti-booking-system").attr("id"):"bookacti-template-calendar";d&&"undefined"!==typeof bookacti.fc_calendar[c]&&10===d.length&&/^\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01])$/.test(d)&&(bookacti_go_to_date=
setTimeout(function(){bookacti.fc_calendar[c].gotoDate(d);a.find(".bookacti-spinner").remove()},750))});$j("body").on("click",".bookacti-booking-system .bookacti-calendar .fc-more",function(){bookacti_refresh_picked_events_on_calendar(booking_system)});$j("body").on("touchstart touchmove touchend touchcancel",".bookacti-booking-system .bookacti-calendar .fc-event",function(a){var d={touchstart:"bookacti_calendar_event_touch_start",touchmove:"bookacti_calendar_event_touch_move",touchend:"bookacti_calendar_event_touch_end",
...
$j("body").on("bookacti_unpick_all_events",".bookacti-booking-system",function(){$j(this).find(".bookacti-calendar").length&&bookacti_unpick_all_events_on_calendar($j(this))})});
