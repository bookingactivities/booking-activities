...
function bookacti_set_calendar_up(a,e){e=e?1:0;var c=a.attr("id");bookacti.booking_system[c].load_events=!1;var f=bookacti_get_availability_period(a),h="undefined"!==typeof bookacti.booking_system[c].display_data?bookacti.booking_system[c].display_data:{},k="undefined"!==typeof bookacti_localized.event_tiny_height?parseInt(bookacti_localized.event_tiny_height):32,p="undefined"!==typeof h.slotMinTime?h.slotMinTime:"00:00";h="undefined"!==typeof h.slotMaxTime?h.slotMaxTime:"24:00";f={locale:bookacti_localized.fullcalendar_locale,
timeZone:bookacti_localized.fullcalendar_timezone,initialView:a.find(".bookacti-calendar:first").width()<bookacti_localized.initial_view_threshold?"timeGridDay":"timeGridWeek",allDaySlot:!1,defaultAllDay:!1,fixedWeekCount:!1,height:"auto",contentHeight:"auto",editable:!1,droppable:!1,eventDurationEditable:!1,showNonCurrentDates:!1,dayMaxEvents:!1,moreLinkClick:"popover",eventDisplay:"block",dragRevertDuration:0,eventShortHeight:0,slotDuration:"00:30",slotEventOverlap:!1,eventMinHeight:k,slotMinTime:p,
slotMaxTime:h,validRange:{start:f.start?moment.utc(f.start.substr(0,10)).format("YYYY-MM-DD"):"",end:f.end?moment.utc(f.end.substr(0,10)).add(1,"days").format("YYYY-MM-DD"):""},headerToolbar:{start:"prev,next today",center:"title",end:"dayGridMonth,timeGridWeek,timeGridDay"},events:function(b,d,g){d([])},viewClassNames:function(b){var d={class_names:[]};a.trigger("bookacti_calendar_view_class_names",[d,b]);return d.class_names},dayHeaderClassNames:function(b){var d={class_names:[]};if("undefined"!==
typeof bookacti.booking_system[c].days_off){var g=bookacti.booking_system[c].days_off,m=moment.utc(b.date);$j.each(g,function(n,l){n=moment.utc(l.from+" 00:00:00");l=moment.utc(l.to+" 23:59:59");if(m.isBetween(n,l,"second","[]"))return d.class_names.push("fc-day-disabled"),!1})}a.trigger("bookacti_calendar_day_header_class_names",[d,b]);return d.class_names},dayCellClassNames:function(b){var d={class_names:[]};if("undefined"!==typeof bookacti.booking_system[c].days_off){var g=bookacti.booking_system[c].days_off,
m=moment.utc(b.date);$j.each(g,function(n,l){n=moment.utc(l.from+" 00:00:00");l=moment.utc(l.to+" 23:59:59");if(m.isBetween(n,l,"second","[]"))return d.class_names.push("fc-day-disabled"),!1})}a.trigger("bookacti_calendar_day_cell_class_names",[d,b]);return d.class_names},datesSet:function(b){if(!0===bookacti.booking_system[c].load_events){var d={start:moment.utc(moment.utc(b.view.currentStart).clone().locale("en").format("YYYY-MM-DD")+" 00:00:00"),end:moment.utc(moment.utc(b.view.currentEnd).clone().subtract(1,
"days").locale("en").format("YYYY-MM-DD")+" 23:59:59")};d=bookacti_get_interval_of_events(a,d);$j.isEmptyObject(d)||bookacti_get_booking_system_data_by_interval(a,d)}a.trigger("bookacti_calendar_view_render",[b])},eventDidMount:function(b){if(!b.isMirror){var d=moment.utc(b.event.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"),g=moment.utc(b.event.end).clone().locale("en").format("YYYY-MM-DD HH:mm:ss");$j(b.el).data("event-id",b.event.groupId);$j(b.el).attr("data-event-id",b.event.groupId);
$j(b.el).data("event-start",d);$j(b.el).attr("data-event-start",d);$j(b.el).data("event-end",g);$j(b.el).attr("data-event-end",g);d=bookacti.booking_system[c].events_data[b.event.groupId];"undefined"!==typeof d.activity_id&&($j(b.el).data("activity-id",d.activity_id),$j(b.el).attr("data-activity-id",d.activity_id));a.trigger("bookacti_calendar_event_did_mount",[b])}},eventClassNames:function(b){var d={class_names:[]};if(b.isMirror||"none"===b.event.display)return d;var g=moment.utc(b.event.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss");
$j.each(bookacti.booking_system[c].picked_events,function(n,l){n=moment.utc(l.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss");l.id==b.event.groupId&&g===n&&d.class_names.push("bookacti-picked-event")});var m=moment.utc(b.event.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss");"undefined"!==typeof bookacti.booking_system[c].bookings[b.event.groupId]&&"undefined"!==typeof bookacti.booking_system[c].bookings[b.event.groupId][m]&&parseInt(bookacti.booking_system[c].bookings[b.event.groupId][m].current_user_bookings)&&
d.class_names.push("bookacti-event-booked-by-current-user");1!=bookacti.booking_system[c].bookings_only&&(bookacti_is_event_available(a,b.event)||d.class_names.push("bookacti-event-unavailable"));if(-1<b.view.type.indexOf("dayGrid")||-1<b.view.type.indexOf("timeGrid"))m=bookacti_fc_get_event_size_classes(a,b.event,b.view),m.length&&(d.class_names=$j.merge(d.class_names,m));a.trigger("bookacti_calendar_event_class_names",[d,b]);return d.class_names},eventContent:function(b){var d={domNodes:[]};if("none"===
b.event.display)return d;var g="LT";-1<b.view.type.indexOf("timeGrid")&&(g=moment.localeData().longDateFormat("LT").replace(/[aA]/g,""));"wp_settings"===bookacti_localized.calendar_localization&&(g=bookacti_convert_php_datetime_format_to_moment_js(bookacti_localized.wp_time_format));g=$j("<div></div>",{"class":"fc-event-time",html:'<span class="bookacti-event-time-start">'+moment.utc(b.event.start).format(g)+'</span><span class="bookacti-event-time-separator"> - </span><span class="bookacti-event-time-end">'+
...
function bookacti_fc_get_event_size_classes(a,e,c){var f=[];if(0>c.type.indexOf("timeGrid")&&0>c.type.indexOf("dayGrid"))return f;var h="undefined"!==typeof bookacti_localized.event_tiny_height?parseInt(bookacti_localized.event_tiny_height):32,k="undefined"!==typeof bookacti_localized.event_small_height?parseInt(bookacti_localized.event_small_height):75,p="undefined"!==typeof bookacti_localized.event_narrow_width?parseInt(bookacti_localized.event_narrow_width):70,b="undefined"!==typeof bookacti_localized.event_wide_width?
parseInt(bookacti_localized.event_wide_width):250;if(-1<c.type.indexOf("timeGrid")){var d=a.attr("id");c=bookacti.fc_calendar[d].getOption("eventMinHeight");d=bookacti.fc_calendar[d].getOption("slotDuration");"undefined"===typeof c&&(c=0);"undefined"===typeof d&&(d="00:30");d=60*parseInt(d.substr(0,2))+parseInt(d.substr(-2));e=parseInt(moment.duration(moment.utc(e.end).diff(moment.utc(e.start))).asMinutes());var g=a.find(".fc-timegrid-slot").length?a.find(".fc-timegrid-slot").outerHeight():0;g||(g=
a.css("line-height").replace("px",""),g=$j.isNumeric(g)?parseFloat(g):0,g||(g=a.css("font-size").replace("px",""),g=$j.isNumeric(g)?1.5*parseFloat(g):0),g=g?g:20);c=Math.max(parseInt(c),g/d*e);c<=h?f.push("bookacti-tiny-event"):c<=k&&f.push("bookacti-small-event")}a=a.find(".fc-col-header-cell.fc-day").innerWidth();a=a-.025*a-2;a>=b?f.push("bookacti-wide-event"):a<=p&&f.push("bookacti-narrow-event");return f}
