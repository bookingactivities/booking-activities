...
slotDuration:"00:30",slotEventOverlap:!1,eventMinHeight:k,nextDayThreshold:r,slotMinTime:q,slotMaxTime:h,validRange:{start:f.start?moment.utc(f.start.substr(0,10)).format("YYYY-MM-DD"):"",end:f.end?moment.utc(f.end.substr(0,10)).add(1,"days").format("YYYY-MM-DD"):""},headerToolbar:{start:"prev,next today",center:"title",end:"dayGridMonth,timeGridWeek,timeGridDay"},events:function(b,e,g){e([])},viewClassNames:function(b){var e={class_names:[]};a.find(".fc-today-button").length&&!a.find(".fc-day-today").length&&
(moment().isBetween(b.view.currentStart,b.view.currentEnd,"day","[)")||a.find(".fc-today-button").attr("disabled",!1));a.trigger("bookacti_calendar_view_class_names",[e,b]);return e.class_names},dayHeaderClassNames:function(b){var e={class_names:[]};if("undefined"!==typeof bookacti.booking_system[c].days_off){var g=bookacti.booking_system[c].days_off,n=moment.utc(b.date);$j.each(g,function(p,l){p=moment.utc(l.from+" 00:00:00");l=moment.utc(l.to+" 23:59:59");if(n.isBetween(p,l,"second","[]"))return e.class_names.push("fc-day-disabled"),
!1})}a.trigger("bookacti_calendar_day_header_class_names",[e,b]);return e.class_names},dayCellClassNames:function(b){var e={class_names:[]};if("undefined"!==typeof bookacti.booking_system[c].days_off){var g=bookacti.booking_system[c].days_off,n=moment.utc(b.date);$j.each(g,function(p,l){p=moment.utc(l.from+" 00:00:00");l=moment.utc(l.to+" 23:59:59");if(n.isBetween(p,l,"second","[]"))return e.class_names.push("fc-day-disabled"),!1})}a.trigger("bookacti_calendar_day_cell_class_names",[e,b]);return e.class_names},
datesSet:function(b){if(!0===bookacti.booking_system[c].load_events){var e={start:moment.utc(moment.utc(b.view.currentStart).clone().locale("en").format("YYYY-MM-DD")+" 00:00:00"),end:moment.utc(moment.utc(b.view.currentEnd).clone().subtract(1,"days").locale("en").format("YYYY-MM-DD")+" 23:59:59")};e=bookacti_get_interval_of_events(a,e);$j.isEmptyObject(e)||bookacti_get_booking_system_data_by_interval(a,e)}a.trigger("bookacti_calendar_view_render",[b])},eventDidMount:function(b){if(!b.isMirror){var e=
moment.utc(b.event.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"),g=moment.utc(b.event.end).clone().locale("en").format("YYYY-MM-DD HH:mm:ss");$j(b.el).data("event-id",b.event.groupId);$j(b.el).attr("data-event-id",b.event.groupId);$j(b.el).data("event-start",e);$j(b.el).attr("data-event-start",e);$j(b.el).data("event-end",g);$j(b.el).attr("data-event-end",g);e=bookacti.booking_system[c].events_data[b.event.groupId];"undefined"!==typeof e.activity_id&&($j(b.el).data("activity-id",e.activity_id),
$j(b.el).attr("data-activity-id",e.activity_id));a.trigger("bookacti_calendar_event_did_mount",[b])}},eventClassNames:function(b){var e={class_names:[]};if(b.isMirror||"none"===b.event.display)return e;var g=moment.utc(b.event.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss");$j.each(bookacti.booking_system[c].picked_events,function(p,l){p=moment.utc(l.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss");l.id==b.event.groupId&&g===p&&e.class_names.push("bookacti-picked-event")});var n=
moment.utc(b.event.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss");"undefined"!==typeof bookacti.booking_system[c].bookings[b.event.groupId]&&"undefined"!==typeof bookacti.booking_system[c].bookings[b.event.groupId][n]&&parseInt(bookacti.booking_system[c].bookings[b.event.groupId][n].current_user_bookings)&&e.class_names.push("bookacti-event-booked-by-current-user");1!=bookacti.booking_system[c].bookings_only&&(bookacti_is_event_available(a,b.event)||e.class_names.push("bookacti-event-unavailable"));
