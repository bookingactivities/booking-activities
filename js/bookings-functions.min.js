...
function bookacti_init_booking_actions(){$j(".bookacti-user-booking-list-table, .woocommerce-table, #bookacti-booking-list").on("click",".bookacti-booking-action, .bookacti-booking-group-action",function(a){a.preventDefault();if(a=$j(this).data("action")){bookacti.user_auth_key=$j(this).data("user-auth-key")?$j(this).data("user-auth-key"):"";var b={booking_ids:[],booking_group_ids:[],all:0,filters:{}};if($j(this).hasClass("bookacti-booking-action")){var e=$j(this).data("booking-id");e&&b.booking_ids.push(parseInt(e))}else(e=
$j(this).data("booking-group-id"))&&b.booking_group_ids.push(parseInt(e));$j(this).attr("href")&&""!==$j(this).attr("href")&&!$j(this).hasClass("prevent-default")?$j(this).hasClass("_blank")?window.open($j(this).attr("href")):location.href=$j(this).attr("href"):bookacti_trigger_booking_action(a,b)}})}
...
$j(this).val();e&&b.booking_ids.push(parseInt(e))});$j('#bookacti-bookings-container tbody .check-column input[name="booking_group_ids[]"]:checked').each(function(){var e=$j(this).val();e&&b.booking_group_ids.push(parseInt(e))});bookacti_trigger_booking_action(a,b)}})}
...
a?bookacti_display_grouped_bookings(b):"cancel"===a?bookacti_dialog_cancel_bookings(b):$j("body").trigger("bookacti_trigger_booking_action",[a,b])}
