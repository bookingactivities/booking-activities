...
bookacti_dialog_change_booking_quantity(b,"group"):$j(this).hasClass("bookacti-show-booking-group-bookings")?bookacti_display_grouped_bookings(b):$j(this).hasClass("bookacti-send-booking-group-notification")?bookacti_dialog_send_booking_notification(b,"group"):$j(this).hasClass("bookacti-delete-booking-group")&&bookacti_dialog_delete_booking(b,"group");$j(this).attr("href")&&""!==$j(this).attr("href")&&!$j(this).hasClass("prevent-default")&&($j(this).hasClass("_blank")?window.open($j(this).attr("href")):
