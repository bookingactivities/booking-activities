...
bookacti_dialog_reschedule_booking(a):$j(this).hasClass("bookacti-refund-booking")?bookacti_dialog_refund_booking(a,"single"):$j(this).hasClass("bookacti-change-booking-state")?bookacti_dialog_change_booking_state(a,"single"):$j(this).hasClass("bookacti-change-booking-quantity")?bookacti_dialog_change_booking_quantity(a,"single"):$j(this).hasClass("bookacti-send-booking-notification")?bookacti_dialog_send_booking_notification(a,"single"):$j(this).hasClass("bookacti-delete-booking")&&bookacti_dialog_delete_booking(a,
...
function bookacti_init_booking_bulk_actions(){$j("body").on("submit",".bookacti-bookings-bulk-action",function(a){-1!=$j(this).find('[name="action"]').val()&&-1!=$j(this).find('[name="action2"]').val()||a.preventDefault()})}
