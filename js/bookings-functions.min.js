...
bookacti_dialog_refund_booking(a,"single"):$j(this).hasClass("bookacti-change-booking-state")?bookacti_dialog_change_booking_state(a,"single"):$j(this).hasClass("bookacti-change-booking-quantity")?bookacti_dialog_change_booking_quantity(a,"single"):$j(this).hasClass("bookacti-send-booking-notification")?bookacti_dialog_send_booking_notification(a,"single"):$j(this).hasClass("bookacti-delete-booking")&&bookacti_dialog_delete_booking(a,"single")):(a=$j(this).data("booking-group-id"),$j(this).hasClass("bookacti-cancel-booking-group")?
bookacti_dialog_cancel_booking(a,"group"):$j(this).hasClass("bookacti-refund-booking-group")?bookacti_dialog_refund_booking(a,"group"):$j(this).hasClass("bookacti-change-booking-group-state")?bookacti_dialog_change_booking_state(a,"group"):$j(this).hasClass("bookacti-change-booking-group-quantity")?bookacti_dialog_change_booking_quantity(a,"group"):$j(this).hasClass("bookacti-show-booking-group-bookings")?bookacti_display_grouped_bookings(a):$j(this).hasClass("bookacti-send-booking-group-notification")?
bookacti_dialog_send_booking_notification(a,"group"):$j(this).hasClass("bookacti-delete-booking-group")&&bookacti_dialog_delete_booking(a,"group"));$j(this).attr("href")&&""!==$j(this).attr("href")&&!$j(this).hasClass("prevent-default")&&($j(this).hasClass("_blank")?window.open($j(this).attr("href")):location.href=$j(this).attr("href"))})}
