...
($j(this).hasClass("_blank")?window.open($j(this).attr("href")):location.href=$j(this).attr("href"))});$j("body.booking-activities_page_bookacti_bookings").length&&bookacti_init_add_and_remove_items()}function bookacti_init_booking_bulk_actions(){$j("body").on("submit",".bookacti-bookings-bulk-action",function(a){-1!=$j(this).find('[name="action"]').val()&&-1!=$j(this).find('[name="action2"]').val()||a.preventDefault()})}
