...
$j(this).data("booking-group-id"))&&e.booking_group_ids.push(parseInt(c));$j(this).attr("href")&&""!==$j(this).attr("href")&&!$j(this).hasClass("prevent-default")?$j(this).hasClass("_blank")?window.open($j(this).attr("href")):location.href=$j(this).attr("href"):bookacti_trigger_booking_action(b,e)}})}
