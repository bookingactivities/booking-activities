...
bookacti_dialog_cancel_booking(b,"single"):$j(this).hasClass("bookacti-reschedule-booking")?bookacti_dialog_reschedule_booking(b):$j(this).hasClass("bookacti-refund-booking")?bookacti_dialog_refund_bookings(a):$j(this).hasClass("bookacti-change-booking-status")?bookacti_dialog_change_bookings_status(a):$j(this).hasClass("bookacti-change-booking-quantity")?bookacti_dialog_change_bookings_quantity(a):$j(this).hasClass("bookacti-send-booking-notification")?bookacti_dialog_send_bookings_notification(a):
...
"reschedule"===a?bookacti_dialog_reschedule_booking(booking_id):"refund"===a?bookacti_dialog_refund_bookings(b):"edit_status"===a?bookacti_dialog_change_bookings_status(b):"edit_quantity"===a?bookacti_dialog_change_bookings_quantity(b):"send_notification"===a?bookacti_dialog_send_bookings_notification(b):"delete"===a&&bookacti_dialog_delete_bookings(b)}})}
