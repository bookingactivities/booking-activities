...
bookacti_dialog_cancel_booking(b,"single"):$j(this).hasClass("bookacti-reschedule-booking")?bookacti_dialog_reschedule_bookings(a):$j(this).hasClass("bookacti-refund-booking")?bookacti_dialog_refund_bookings(a):$j(this).hasClass("bookacti-change-booking-status")?bookacti_dialog_change_bookings_status(a):$j(this).hasClass("bookacti-change-booking-quantity")?bookacti_dialog_change_bookings_quantity(a):$j(this).hasClass("bookacti-send-booking-notification")?bookacti_dialog_send_bookings_notification(a):
$j(this).hasClass("bookacti-delete-booking")&&bookacti_dialog_delete_bookings(a)}else b=$j(this).data("booking-group-id"),a.booking_group_ids.push(b),$j(this).hasClass("bookacti-cancel-booking-group")?bookacti_dialog_cancel_booking(b,"group"):$j(this).hasClass("bookacti-refund-booking-group")?bookacti_dialog_refund_booking(b,"group"):$j(this).hasClass("bookacti-change-booking-group-state")?bookacti_dialog_change_bookings_status(a):$j(this).hasClass("bookacti-change-booking-group-quantity")?bookacti_dialog_change_bookings_quantity(a):
$j(this).hasClass("bookacti-show-booking-group-bookings")?bookacti_display_grouped_bookings(b):$j(this).hasClass("bookacti-send-booking-group-notification")?bookacti_dialog_send_bookings_notification(a):$j(this).hasClass("bookacti-delete-booking-group")&&bookacti_dialog_delete_bookings(a);$j(this).attr("href")&&""!==$j(this).attr("href")&&!$j(this).hasClass("prevent-default")&&($j(this).hasClass("_blank")?window.open($j(this).attr("href")):location.href=$j(this).attr("href"))})}
...
"reschedule"===a?bookacti_dialog_reschedule_bookings(b):"refund"===a?bookacti_dialog_refund_bookings(b):"edit_status"===a?bookacti_dialog_change_bookings_status(b):"edit_quantity"===a?bookacti_dialog_change_bookings_quantity(b):"send_notification"===a?bookacti_dialog_send_bookings_notification(b):"delete"===a&&bookacti_dialog_delete_bookings(b)}})}
