...
function bookacti_validate_activity_form(){var a=$j("#bookacti-activity-title").val(),e=$j("#bookacti-activity-color").val(),f=$j("#bookacti-activity-availability").val(),b=$j("#bookacti-activity-duration-days").val(),g=$j("#bookacti-activity-duration-hours").val(),d=$j("#bookacti-activity-duration-minutes").val(),c={isTitle:!1,isColor:!1,isColorWhite:!1,isAvail:!1,isAvailPositive:!1,isDays:!1,isHours:!1,isMinutes:!1,isDaysInfTo365:!1,isHoursInfTo23:!1,isMinutesInfTo59:!1,isSupToZero:!1,send:!1};
a.length&&(c.isTitle=!0);e.length&&(c.isColor=!0);c.isColor&&"#ffffff"===e&&(c.isColorWhite=!0);f.length&&(c.isAvail=!0);c.isAvail&&0<=parseInt(f)&&(c.isAvailPositive=!0);b.length&&(c.isDays=!0);g.length&&(c.isHours=!0);d.length&&(c.isMinutes=!0);c.isDays&&365>=b&&0<=b&&(c.isDaysInfTo365=!0);c.isHours&&23>=g&&0<=g&&(c.isHoursInfTo23=!0);c.isMinutes&&59>=d&&0<=d&&(c.isMinutesInfTo59=!0);if(0<b||0<g||0<d)c.isSupToZero=!0;c.isTitle&&c.isColor&&c.isAvailPositive&&c.isDaysInfTo365&&c.isHoursInfTo23&&c.isMinutesInfTo59&&
