...
function(){$j("#bookacti-display-group-category-user-roles").prop("checked",$j("#bookacti-group-category-roles option:selected").length).trigger("change")});$j("body").on("bookacti_empty_all_dialogs_forms",function(a,e){$j(e+" #bookacti-display-activity-user-roles, "+e+" #bookacti-display-group-category-user-roles").prop("checked",!1).trigger("change")});$j("#bookacti-activity-reschedule-scope").on("change",function(){var a=$j(this).val()||"";$j("#bookacti-activity-reschedule-activity-ids-container").toggle(-1<
a.indexOf("custom"))})});
