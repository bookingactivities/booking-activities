...
bookacti.fc_calendar["bookacti-template-calendar"].gotoDate(d[0].start);var f={action:"bookactiBeforeDeleteGroupOfEvents",group_id:a,nonce:$j('#bookacti-delete-group-of-events-form input[name="nonce"]').val()};$j("#bookacti-group-of-events-dialog").trigger("bookacti_before_deactivate_group_of_events",[f,a]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-group-of-events-dialog"));$j.ajax({url:ajaxurl,data:f,type:"POST",dataType:"json",success:function(g){if(g.status==="success")$j("#bookacti-group-of-events-dialog").dialog("close"),
