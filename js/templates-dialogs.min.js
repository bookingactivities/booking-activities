...
var e={action:"bookactiBeforeDeleteEvent",event_id:a.groupId,nonce:$j("#nonce_delete_event").val()};$j("#bookacti-event-data-dialog").trigger("bookacti_before_deactivate_event",[e,a]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-event-data-dialog"));$j.ajax({url:ajaxurl,data:e,type:"POST",dataType:"json",success:function(f){if("success"===f.status)$j("#bookacti-event-data-dialog").dialog("close"),bookacti_dialog_delete_event(a),$j("#bookacti-delete-booked-event-options").toggle(parseInt(f.has_bookings)?
...
[a]);var c=[{text:bookacti_localized.dialog_button_delete,"class":"bookacti-dialog-delete-button",click:function(){$j("#bookacti-delete-event-dialog .bookacti-notices").remove();var b=$j("#bookacti-delete-event-form").serializeObject();b.event_id=a.groupId;$j("#bookacti-delete-event-dialog").trigger("bookacti_deactivate_event_before",[b,a]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-delete-event-dialog"));$j.ajax({url:ajaxurl,data:b,type:"POST",dataType:"json",success:function(d){if("success"===
d.status)bookacti_unselect_event(a),bookacti.booking_system["bookacti-template-calendar"].groups_data=d.groups_data,bookacti.booking_system["bookacti-template-calendar"].groups_events=[],bookacti_fc_remove_events_by_groupId($j("#bookacti-template-calendar"),a.groupId),$j("#bookacti-delete-event-dialog").trigger("bookacti_event_deactivated",[d,b,a]),$j("#bookacti-delete-event-dialog").dialog("close");else{var e="undefined"!==typeof d.message?d.message:bookacti_localized.error;$j("#bookacti-delete-event-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
e+"</li></ul></div>");$j("#bookacti-delete-event-dialog .bookacti-notices").show();console.log(d)}},error:function(d){alert("AJAX "+bookacti_localized.error);console.log(d)},complete:function(){bookacti_stop_template_loading();bookacti_remove_loading_html($j("#bookacti-delete-event-dialog"))}})}},{text:bookacti_localized.dialog_button_cancel,click:function(){$j(this).dialog("close")}}];"none"!==bookacti.booking_system["bookacti-template-calendar"].events_data[a.groupId].repeat_freq&&($j(".bookacti-delete-booked-repeated-event-warning").show(),
c.push({text:bookacti_localized.dialog_button_unbind,"class":"bookacti-dialog-left-button",click:function(){$j(this).dialog("close");bookacti_dialog_unbind_event_occurrences(a)}}));$j("#bookacti-delete-event-dialog").dialog("option","buttons",c);$j("#bookacti-delete-event-dialog").dialog("open")}
...
var c=[{text:bookacti_localized.dialog_button_unbind,"class":"bookacti-dialog-delete-button",click:function(){$j("#bookacti-unbind-event-dialog .bookacti-notices").remove();$j("#bookacti-unbind-event-dialog .bookacti-form-error").remove();$j("#bookacti-unbind-event-dialog .bookacti-input-warning").removeClass("bookacti-input-warning");var b=$j("#bookacti-unbind-event-form").serializeObject(),d=moment.utc(a.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"),e=$j.extend({event_id:a.groupId,event_start:d,
event_end:moment.utc(a.end).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"),interval:bookacti.booking_system["bookacti-template-calendar"].events_interval},b);$j("#bookacti-template-container").trigger("bookacti_unbind_event_occurrences_before",[e,a]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-unbind-event-dialog"));$j.ajax({url:ajaxurl,data:e,type:"POST",dataType:"json",success:function(f){if("success"===f.status)bookacti_unselect_event(a,!0),bookacti.booking_system["bookacti-template-calendar"].groups_data=
...
click:function(){$j("#bookacti-activity-import-dialog .bookacti-notices").remove();var a=$j("select#bookacti-activities-to-import").val();if($j.isEmptyObject(a))$j("#bookacti-activity-import-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+bookacti_localized.error_fill_field+"</li></ul></div>");else{var c={action:"bookactiImportActivities",activity_ids:a,template_id:bookacti.selected_template,nonce:$j("#nonce_import_activity").val()};$j("#bookacti-activity-import-dialog").trigger("bookacti_import_activities_before",
[c]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-activity-import-dialog"));$j.ajax({url:ajaxurl,data:c,type:"POST",dataType:"json",success:function(b){if("success"===b.status)bookacti.booking_system["bookacti-template-calendar"].activities_data=b.activities_data,b.activity_list&&$j("#bookacti-template-activity-list").empty().append(b.activity_list),$j.each(a,function(e,f){$j('select#bookacti-activities-to-import option[value="'+f+'"]').remove()}),bookacti_refresh_activity_list(),
$j("#bookacti-activity-import-dialog").trigger("bookacti_activities_imported",[b,c]),$j("#bookacti-activity-import-dialog").dialog("close"),$j("#bookacti-activity-create-method-dialog").dialog("close");else{var d="undefined"!==typeof b.message?b.message:bookacti_localized.error;$j("#bookacti-activity-import-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+d+"</li></ul></div>");$j("#bookacti-activity-import-dialog .bookacti-notices").show();console.log(b)}},error:function(b){alert("AJAX "+
...
"buttons",[{text:bookacti_localized.dialog_button_ok,click:function(){$j("#bookacti-activity-data-dialog .bookacti-notices").remove();"undefined"!==typeof tinyMCE&&tinyMCE&&tinyMCE.triggerSave();if(bookacti_validate_activity_form()){var c=$j("#bookacti-activity-data-form").serializeObject();$j("#bookacti-activity-data-dialog").trigger("bookacti_insert_activity_before",[c]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-activity-data-dialog"));$j.ajax({url:ajaxurl,data:c,
type:"POST",dataType:"json",success:function(b){if("success"===b.status)bookacti.booking_system["bookacti-template-calendar"].activities_data[b.activity_id]=b.activity_data,b.activity_list&&$j("#bookacti-template-activity-list").empty().append(b.activity_list),bookacti_refresh_activity_list(),$j("#bookacti-activity-data-dialog").trigger("bookacti_activity_inserted",[b,c]),$j("#bookacti-activity-data-dialog").dialog("close"),$j("#bookacti-activity-create-method-dialog").dialog("close");else if("failed"===
b.status){var d="undefined"!==typeof b.message?b.message:bookacti_localized.error;$j("#bookacti-activity-data-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+d+"</li></ul></div>");$j("#bookacti-activity-data-dialog .bookacti-notices").show();console.log(b)}},error:function(b){alert("AJAX "+bookacti_localized.error);console.log(b)},complete:function(){bookacti_stop_template_loading();bookacti_remove_loading_html($j("#bookacti-activity-data-dialog"))}})}}}]);$j("#bookacti-activity-data-dialog").dialog("open")}}
...
1:0,nonce:$j("#nonce_deactivate_activity").val()};$j("#bookacti-delete-activity-dialog").trigger("bookacti_deactivate_activity_before",[c,a]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-delete-activity-dialog"));$j.ajax({url:ajaxurl,data:c,type:"POST",dataType:"json",success:function(b){if("success"===b.status)delete bookacti.booking_system["bookacti-template-calendar"].activities_data[a],$j('.bookacti-activity[data-activity-id="'+a+'"]').remove(),c.delete_events&&(bookacti.booking_system["bookacti-template-calendar"].groups_data=
b.groups_data,bookacti.booking_system["bookacti-template-calendar"].groups_events=[],bookacti_refetch_events_on_calendar_editor()),bookacti_display_activity_tuto_if_no_activity_available(),$j("#bookacti-delete-activity-dialog").trigger("bookacti_activity_deactivated",[b,c,a]),$j("#bookacti-delete-activity-dialog").dialog("close"),$j("#bookacti-activity-data-dialog").dialog("close"),$j("#bookacti-activity-create-method-dialog").dialog("close");else{var d="undefined"!==typeof b.message?b.message:bookacti_localized.error;
$j("#bookacti-delete-activity-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+d+"</li></ul></div>");$j("#bookacti-delete-activity-dialog .bookacti-notices").show();console.log(b)}},error:function(b){alert("AJAX "+bookacti_localized.error);console.log(b)},complete:function(){bookacti_stop_template_loading();bookacti_remove_loading_html($j("#bookacti-delete-activity-dialog"))}})}},{text:bookacti_localized.dialog_button_cancel,click:function(){$j("#bookacti-delete-activity-dialog").dialog("close")}}]))}
...
bookacti_fill_selected_events_list();c=bookacti.booking_system["bookacti-template-calendar"].groups_data[a];var e=[];"undefined"!==typeof bookacti.booking_system["bookacti-template-calendar"].groups_events[a]&&(e=$j.extend({},bookacti.booking_system["bookacti-template-calendar"].groups_events[a]));e=Object.keys(e);$j("#bookacti-group-of-events-title-field").val(c.multilingual_title);$j("#bookacti-group-of-events-occurrences-prev, #bookacti-group-of-events-occurrences-next").toggle(1<e.length);$j("#bookacti-group-of-events-occurrences-navigation").show();
e.length||bookacti_get_group_of_events_occurrences(a);bookacti_fill_repetition_fields(a,"group");c.settings&&bookacti_fill_fields_from_array(c.settings,"","#bookacti-group-of-events-dialog");$j("#bookacti-group-of-events-dialog").trigger("bookacti_group_of_events_update_dialog",[a]);bookacti_localized.is_qtranslate&&$j("#bookacti-group-of-events-dialog .qtranxs-translatable").each(function(){bookacti_refresh_qtx_field(this)});bookacti_validate_group_of_events_form();c=[];c.push({text:bookacti_localized.dialog_button_ok,
click:function(){$j("#bookacti-group-of-events-dialog .bookacti-notices").remove();$j("#bookacti-group-of-events-action").val("bookactiUpdateGroupOfEvents");bookacti.booking_system["bookacti-template-calendar"].selected_events=d.slice();bookacti_fill_selected_events_list();bookacti_refresh_selected_events_display();var f=$j("#bookacti-group-of-events-category-selectbox").val();bookacti.selected_category=f;"undefined"!==typeof tinyMCE&&tinyMCE&&tinyMCE.triggerSave();if(bookacti_validate_group_of_events_form()){var g=
$j("#bookacti-group-of-events-form").serializeObject();g.action="bookactiUpdateGroupOfEvents";g.group_id=a;g.interval=JSON.stringify(bookacti.booking_system["bookacti-template-calendar"].events_interval);g.events=JSON.stringify(bookacti.booking_system["bookacti-template-calendar"].selected_events);$j("#bookacti-group-of-events-dialog").trigger("bookacti_update_group_of_events_before",[g,a]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-group-of-events-dialog"));$j.ajax({url:ajaxurl,
data:g,type:"POST",dataType:"json",success:function(h){if("success"===h.status)bookacti.booking_system["bookacti-template-calendar"].groups_data[a]=h.group_data,bookacti.booking_system["bookacti-template-calendar"].groups_events[a]=h.group_events,bookacti.booking_system["bookacti-template-calendar"].group_categories_data[h.category_id]=h.category,bookacti.booking_system["bookacti-template-calendar"].selected_events=[],"new"===f&&bookacti_add_group_category(h.category_id,h.category.title),b!=f?($j('.bookacti-group-of-events[data-group-id="'+
a+'"]').remove(),bookacti_add_group_of_events(a,h.group_title_raw,h.category_id)):($j('.bookacti-group-of-events[data-group-id="'+a+'"] .bookacti-group-of-events-title').attr("title",h.group_title_raw),$j('.bookacti-group-of-events[data-group-id="'+a+'"] .bookacti-group-of-events-title').html(h.group_title_raw)),bookacti_unselect_all_events(),bookacti.fc_calendar["bookacti-template-calendar"].render(),$j("#bookacti-group-of-events-dialog").trigger("bookacti_group_of_events_updated",[h,g,a]);else if("failed"===
h.status){var l="undefined"!==typeof h.message?h.message:bookacti_localized.error;$j("#bookacti-group-of-events-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+l+"</li></ul></div>");$j("#bookacti-group-of-events-dialog .bookacti-notices").show();console.log(h)}"failed"!==h.status&&$j("#bookacti-group-of-events-dialog").dialog("close")},error:function(h){alert("AJAX "+bookacti_localized.error);console.log(h)},complete:function(){bookacti_stop_template_loading();
bookacti_remove_loading_html($j("#bookacti-group-of-events-dialog"))}})}}});c.push({text:bookacti_localized.dialog_button_delete,"class":"bookacti-dialog-delete-button bookacti-dialog-left-button",click:function(){$j("#bookacti-group-of-events-dialog .bookacti-notices").remove();bookacti.booking_system["bookacti-template-calendar"].selected_events=d.slice();bookacti_fill_selected_events_list();bookacti_refresh_selected_events_display();bookacti.fc_calendar["bookacti-template-calendar"].gotoDate(d[0].start);
var f={action:"bookactiBeforeDeleteGroupOfEvents",group_id:a,nonce:$j("#nonce_delete_group_of_events").val()};$j("#bookacti-group-of-events-dialog").trigger("bookacti_before_deactivate_group_of_events",[f,a]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-group-of-events-dialog"));$j.ajax({url:ajaxurl,data:f,type:"POST",dataType:"json",success:function(g){if("success"===g.status)$j("#bookacti-group-of-events-dialog").dialog("close"),bookacti_dialog_delete_group_of_events(a),
$j("#bookacti-delete-booked-group-of-events-options").toggle(parseInt(g.has_bookings)?!0:!1),$j("#bookacti-delete-group-of-events-cancel_bookings").prop("checked",parseInt(g.has_bookings)?!0:!1).trigger("change"),$j("#bookacti-delete-group-of-events-cancel_bookings-container").append('<span class="bookacti-bookings-nb">'+g.booking_groups_nb+" ("+g.bookings_nb+")</span>"),$j("#bookacti-delete-group-of-events-send_notifications-container").append('<span class="bookacti-notifications-nb">'+g.notifications_nb+
...
$j("#bookacti-unbind-group-of-events-dialog .bookacti-form-error").remove();$j("#bookacti-unbind-group-of-events-dialog .bookacti-input-warning").removeClass("bookacti-input-warning");var d=$j("#bookacti-unbind-group-of-events-form").serializeObject(),e=$j.extend({group_id:a,group_date:c},d);$j("#bookacti-template-container").trigger("bookacti_unbind_group_of_events_occurrences_before",[e,a,c]);bookacti_start_template_loading();bookacti_add_loading_html($j("#bookacti-unbind-group-of-events-dialog"));
