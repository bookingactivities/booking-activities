...
function bookacti_get_group_of_events_occurrences(a){var c={action:"bookactiGetGroupOfEvents",group_id:a,nonce:$j("#nonce_insert_or_update_group_of_events").val()};$j("#bookacti-group-of-events-dialog").trigger("bookacti_get_group_of_events_occurrences_before",[c,a]);$j("#bookacti-group-of-events-occurrences-navigation > .button").hide();bookacti_add_loading_html($j("#bookacti-group-of-events-occurrences-navigation"));$j.ajax({url:ajaxurl,data:c,type:"POST",dataType:"json",success:function(b){if("success"===
