...
function bookacti_get_group_of_events_occurrences(a){var c={action:"bookactiGetGroupOfEvents",group_id:a,nonce:$j("#nonce_insert_or_update_group_of_events").val()};$j("#bookacti-group-of-events-dialog").trigger("bookacti_get_group_of_events_occurrences_before",[c,a]);bookacti_add_loading_html($j("#bookacti-group-of-events-occurrences-navigation"));$j.ajax({url:ajaxurl,data:c,type:"POST",dataType:"json",success:function(b){if("success"===b.status){bookacti.booking_system["bookacti-template-calendar"].groups_data[a]=
b.group_data;bookacti.booking_system["bookacti-template-calendar"].groups_events[a]=b.group_events;bookacti_fill_repetition_fields(a,"group");var d=Object.keys(b.group_events);$j("#bookacti-group-of-events-occurrences-prev, #bookacti-group-of-events-occurrences-next").toggle(1<d.length);$j("#bookacti-group-of-events-dialog").trigger("bookacti_group_of_events_occurrences_retrieved",[b,c,a])}else"failed"===b.status&&(d="undefined"!==typeof b.message?b.message:bookacti_localized.error,$j("#bookacti-group-of-events-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+
d+"</li></ul></div>"),$j("#bookacti-group-of-events-dialog .bookacti-notices").show(),console.log(b))},error:function(b){alert("AJAX "+bookacti_localized.error);console.log(b)},complete:function(){bookacti_remove_loading_html($j("#bookacti-group-of-events-occurrences-navigation"))}})}
