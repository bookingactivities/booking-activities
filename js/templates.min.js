...
null},customButtons:{goTo:{text:bookacti_localized.go_to_button,click:function(){$j(".bookacti-go-to-datepicker").length||($j(".fc-goTo-button").after('<input type="date" class="bookacti-go-to-datepicker"/>'),$j(".bookacti-go-to-datepicker").hide());$j(".bookacti-go-to-datepicker").toggle(200);$j(".fc-goTo-button .bookacti-spinner").remove()}}},headerToolbar:{start:"prevYear,prev,next,nextYear today goTo",center:"title",end:"dayGridMonth,timeGridWeek,timeGridDay"},events:function(a,c,b){c([])},viewClassNames:function(a){var c=
