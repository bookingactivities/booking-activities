...
[],bookacti.booking_system["bookacti-template-calendar"].template_data=[],bookacti.booking_system["bookacti-template-calendar"].selected_events=[],bookacti.booking_system["bookacti-template-calendar"].picked_events=[],bookacti.booking_system["bookacti-template-calendar"].loading_number=0,bookacti.booking_system["bookacti-template-calendar"].method="calendar",bookacti.booking_system["bookacti-template-calendar"].past_events=!0,bookacti.booking_system["bookacti-template-calendar"].past_events_bookable=
!0,bookacti_make_activities_draggable(),bookacti_make_activities_sortable(),bookacti_init_groups_of_events(),bookacti_init_show_hide_activities_switch(),bookacti_init_event_duplication_feedbacks(),bookacti_init_template_dialogs(),bookacti_bind_template_dialogs(),$j("body").on("change","#bookacti-template-picker",function(){bookacti_switch_template($j(this).val())}),bookacti.selected_template&&bookacti_switch_template(bookacti.selected_template),$j("body").on("bookacti_init_booking_sytem","#bookacti-template-calendar",
function(f,h,l){h.load=!1}),$j("body").on("dragstart","#bookacti-template-activities-container .fc-event",function(f,h){h.helper.css("maxWidth",$j(this).width())}),$j("body").on("bookacti_clear_events","#bookacti-template-calendar",function(f,h){bookacti_clear_events_on_calendar_editor()}),window.onerror=function(f,h,l,m,t){$j("#bookacti-fatal-error").show()},$j("body").on("click","#bookacti-exit-loading",function(){bookacti_stop_template_loading(!0);bookacti.load_events=!0}))});
...
[a])},eventMouseEnter:function(a){bookacti.is_touch_device||f.trigger("bookacti_calendar_editor_event_mouse_enter",[a])},eventMouseLeave:function(a){bookacti.is_touch_device||f.trigger("bookacti_calendar_editor_event_mouse_leave",[a])},loading:function(a){!a&&bookacti.is_touch_device&&$j(".fc-event").each(function(){var c=$j.Event("mouseover",{target:this.firstChild,_dummyCalledOnStartup:!0});$j(this).trigger(c)})}};"wp_settings"===bookacti_localized.calendar_localization&&(m=bookacti_convert_php_datetime_format_to_fc_date_formatting_object(bookacti_localized.wp_time_format),
