...
f.has_logged_in?a.find(".bookacti-new-booking-button").addClass("bookacti-reload-page"):a.find(".bookacti-new-booking-button").removeClass("bookacti-reload-page"),a.find(".bookacti-new-booking-button").show(),k="<ul class='bookacti-success-list bookacti-persistent-notice'><li>"+f.message+"</li></ul>",0>h.indexOf("://")&&bookacti_refresh_booking_numbers(b);k&&(d.empty().append(k).show(),"success"===f.status&&h||bookacti_scroll_to(d,500,"middle"));k=bookacti_serialize_object(a);a.trigger("bookacti_booking_form_submitted",
