...
!1)));if($j(d+'input[type="checkbox"][name="'+e+'[]"]').length||$j(d+'input[type="checkbox"][name="'+e+'"]').length)$j.isArray(c)?($j(d+'input[type="checkbox"][name="'+e+'[]"]').prop("checked",!1),$j.each(c,function(k,l){$j(d+'input[type="checkbox"][name="'+e+'[]"][value="'+l+'"]').prop("checked",!0).trigger("change")})):1==c?$j(d+'input[type="checkbox"][name="'+e+'"]').prop("checked",!0).trigger("change"):$j(d+'input[type="checkbox"][name="'+e+'"]').prop("checked",!1).trigger("change");else if($j(d+
'input[name="'+e+'"]').is(":radio"))$j(d+'input[name="'+e+'"][value="'+c+'"]').prop("checked",!0).trigger("change");else if($j(d+'select[name="'+e+'"]').length)$j(d+'select[name="'+e+'"] option[value="'+c+'"]').prop("selected",!0),$j(d+'select[name="'+e+'"]').trigger("change");else if($j(d+'select[name="'+e+'[]"]').length)$j.isArray(c)||(c=[c]),$j.each(c,function(k,l){k=$j(d+'select[name="'+e+'[]"] option[value="'+l+'"]');$j(d+'select[name="'+e+'[]"] option[value="'+l+'"]').prop("selected",!0);$j(d+
'select[name="'+e+'[]"]').data("sortable")&&(k.detach(),$j(d+'select[name="'+e+'[]"]').append(k))}),$j(d+'select[name="'+e+'[]"]').trigger("change");else{if("file"===$j(d+'input[name="'+e+'"]').attr("type"))return!0;"color"!==$j(d+'input[name="'+e+'"]').attr("type")||c||(c="#3a87ad");"time"===$j(d+'input[name="'+e+'"]').attr("type")&&24<=parseInt(c.substr(0,2))&&(c=bookacti_pad(parseInt(c.substr(0,2))%24,2)+c.substr(2));$j(d+'input[name="'+e+'"]').val(c).trigger("change");$j(d+'textarea[name="'+e+
'"]').val(c).trigger("change");"undefined"!==typeof tinyMCE&&tinyMCE&&$j(d+'textarea[name="'+e+'"]').hasClass("wp-editor-area")&&(f=$j(d+'textarea[name="'+e+'"]').attr("id"),tinyMCE.get(f)&&tinyMCE.get(f).setContent(c));if($j(d+'input[name="'+e+'"].bookacti-duration-value').length){f="";if($j.isNumeric(c)&&(c=parseInt(c),0<=c)){var g=Math.floor(c/86400);c%=86400;var h=Math.floor(c/3600);f=Math.floor(c%3600/60)}$j(d+'input[name="'+e+'"].bookacti-duration-value').siblings(".bookacti-duration-field-container").find('.bookacti-duration-field[data-unit="day"]').val(g).trigger("change");
$j(d+'input[name="'+e+'"].bookacti-duration-value').siblings(".bookacti-duration-field-container").find('.bookacti-duration-field[data-unit="hour"]').val(h).trigger("change");$j(d+'input[name="'+e+'"].bookacti-duration-value').siblings(".bookacti-duration-field-container").find('.bookacti-duration-field[data-unit="minute"]').val(f).trigger("change")}}})}
