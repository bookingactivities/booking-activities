...
function bookacti_init_add_and_remove_items(){$j("body").on("click",".bookacti-items-container .bookacti-add-items",function(a){var b=$j(this).closest(".bookacti-items-container");a=b.find(".bookacti-add-new-items-select-box");var d=a.is("[multiple]"),f=a.val(),c=f;d||(c=[f]);$j.each(c,function(e,g){b.find('.bookacti-add-new-items-select-box option[value="'+g+'"]').clone().appendTo(b.find(".bookacti-items-select-box"));b.find('.bookacti-add-new-items-select-box option[value="'+g+'"]').hide().attr("disabled",
!0);b.find(".bookacti-add-new-items-select-box").val(b.find(".bookacti-add-new-items-select-box option:enabled:first").val())});a.hasClass("select2-hidden-accessible")&&(a.select2("destroy"),bookacti_select2_init())});$j("body").on("click",".bookacti-items-container .bookacti-remove-items",function(a){var b=$j(this).closest(".bookacti-items-container");a=b.data("type");var d="";"users"===a?d=bookacti_localized.current_user_id:"templates"===a&&(d=bookacti.selected_template);a=b.find(".bookacti-add-new-items-select-box");
var f=b.find(".bookacti-items-select-box").is("[multiple]"),c=b.find(".bookacti-items-select-box").val(),e=c;f||(e=[c]);$j.each(e,function(g,h){h!=d&&(b.find('.bookacti-items-select-box option[value="'+h+'"]').remove(),b.find('.bookacti-add-new-items-select-box option[value="'+h+'"]').show().attr("disabled",!1),b.find(".bookacti-add-new-items-select-box").val(h))});a.hasClass("select2-hidden-accessible")&&(a.select2("destroy"),bookacti_select2_init())})}
...
$j(a+'input[type="date"]').val("");$j(a+'input[type="time"]').val("");$j(a+"textarea").val("");$j(a+'input[type="color"]').val("#3a87ad");$j(a+'input[type="checkbox"]').prop("checked",!1);$j(a+'input[type="radio"]').prop("checked",!1);$j(a+"select").val(null).trigger("change");$j(a+".bookacti-duration-hint").remove();$j(a+'input[type="file"]').length&&$j(a+'input[type="file"]').each(function(){$j(this).wrap("<form>").closest("form").get(0).reset();$j(this).unwrap()});"undefined"!==typeof tinyMCE&&
tinyMCE&&$j(a+"textarea.wp-editor-area").each(function(){var b=$j(this).attr("id");tinyMCE.get(b)&&tinyMCE.get(b).setContent("")});$j(a+".bookacti-multiple-select").length&&$j(a+".bookacti-multiple-select").each(function(){bookacti_switch_select_to_multiple(this)});$j("body").trigger("bookacti_empty_all_dialogs_forms",[a])}
...
'input.bookacti-multiple-select[data-select-id="'+f+'"]'),$j(d+'select[name="'+e+'"] option').prop("selected",!1)));$j(d+'select[name="'+e+'"]:not(.bookacti-items-select-box)').length&&$j.isArray(c)&&1<c.length&&(f=$j(d+'select[name="'+e+'"]').attr("id"),$j(d+'input.bookacti-multiple-select[data-select-id="'+f+'"]').length&&($j(d+'input.bookacti-multiple-select[data-select-id="'+f+'"]').prop("checked",!0),bookacti_switch_select_to_multiple(d+'input.bookacti-multiple-select[data-select-id="'+f+'"]'),
$j(d+'select[name="'+e+'[]"] option').prop("selected",!1)));if($j(d+'input[type="checkbox"][name="'+e+'[]"]').length||$j(d+'input[type="checkbox"][name="'+e+'"]').length)$j.isArray(c)?($j(d+'input[type="checkbox"][name="'+e+'[]"]').prop("checked",!1),$j.each(c,function(l,k){$j(d+'input[type="checkbox"][name="'+e+'[]"][value="'+k+'"]').prop("checked",!0).trigger("change")})):1==c?$j(d+'input[type="checkbox"][name="'+e+'"]').prop("checked",!0).trigger("change"):$j(d+'input[type="checkbox"][name="'+
e+'"]').prop("checked",!1).trigger("change");else if($j(d+'input[name="'+e+'"]').is(":radio"))$j(d+'input[name="'+e+'"][value="'+c+'"]').prop("checked",!0).trigger("change");else if($j(d+'select[name="'+e+'[]"].bookacti-items-select-box').length){$j.isArray(c)||(c=[c]);var g=$j(d+'select[name="'+e+'[]"].bookacti-items-select-box'),h=g.closest(".bookacti-items-container").find(".bookacti-add-new-items-select-box");h.find("option").show().attr("disabled",!1);g.find("option").remove();$j.each(c,function(l,
k){h.find('option[value="'+k+'"]').clone().appendTo(g);h.find('option[value="'+k+'"]').hide().attr("disabled",!0);h.val()!=k&&h.val()||h.val(h.find("option:enabled:first").val())});g.find("option").length&&(g.find("option").prop("selected",!0),g.trigger("change"))}else if($j(d+'select[name="'+e+'"]').length)$j(d+'select[name="'+e+'"] option[value="'+c+'"]').prop("selected",!0),$j(d+'select[name="'+e+'"]').trigger("change");else if($j(d+'select[name="'+e+'[]"]').length)$j.isArray(c)||(c=[c]),$j.each(c,
function(l,k){l=$j(d+'select[name="'+e+'[]"] option[value="'+k+'"]');$j(d+'select[name="'+e+'[]"] option[value="'+k+'"]').prop("selected",!0);$j(d+'select[name="'+e+'[]"]').data("sortable")&&(l.detach(),$j(d+'select[name="'+e+'[]"]').append(l))}),$j(d+'select[name="'+e+'[]"]').trigger("change");else{if("file"===$j(d+'input[name="'+e+'"]').attr("type"))return!0;"color"!==$j(d+'input[name="'+e+'"]').attr("type")||c||(c="#3a87ad");"time"===$j(d+'input[name="'+e+'"]').attr("type")&&24<=parseInt(c.substr(0,
2))&&(c=bookacti_pad(parseInt(c.substr(0,2))%24,2)+c.substr(2));$j(d+'input[name="'+e+'"]').val(c).trigger("change");$j(d+'textarea[name="'+e+'"]').val(c).trigger("change");"undefined"!==typeof tinyMCE&&tinyMCE&&$j(d+'textarea[name="'+e+'"]').hasClass("wp-editor-area")&&(f=$j(d+'textarea[name="'+e+'"]').attr("id"),tinyMCE.get(f)&&tinyMCE.get(f).setContent(c));if($j(d+'input[name="'+e+'"].bookacti-duration-value').length){f="";if($j.isNumeric(c)&&(c=parseInt(c),0<=c)){var m=Math.floor(c/86400);c%=
86400;var n=Math.floor(c/3600);f=Math.floor(c%3600/60)}$j(d+'input[name="'+e+'"].bookacti-duration-value').siblings(".bookacti-duration-field-container").find('.bookacti-duration-field[data-unit="day"]').val(m).trigger("change");$j(d+'input[name="'+e+'"].bookacti-duration-value').siblings(".bookacti-duration-field-container").find('.bookacti-duration-field[data-unit="hour"]').val(n).trigger("change");$j(d+'input[name="'+e+'"].bookacti-duration-value').siblings(".bookacti-duration-field-container").find('.bookacti-duration-field[data-unit="minute"]').val(f).trigger("change")}}})}
function bookacti_switch_select_to_multiple(a){if($j(a).length){var b=$j(a).data("select-id"),d=$j("select#"+b).attr("name"),f=$j(a).is(":checked"),c=$j("select#"+b).val();$j("select#"+b).prop("multiple",f);$j("select#"+b+' option[value="all"]').prop("disabled",f);$j("select#"+b+' option[value="none"]').prop("disabled",f);$j("select#"+b+' option[value="parent"]').prop("disabled",f);$j("select#"+b+' option[value="site"]').prop("disabled",f);$j("select#"+b+" option:disabled:selected").prop("selected",
!1);f&&0>d.indexOf("[]")?($j("select#"+b).attr("name",d+"[]"),$j(a).closest(".bookacti-multiple-select-container").find("label span.dashicons").removeClass("dashicons-plus").addClass("dashicons-minus")):($j("select#"+b).attr("name",d.replace("[]","")),$j(a).closest(".bookacti-multiple-select-container").find("label span.dashicons").removeClass("dashicons-minus").addClass("dashicons-plus"));if(!f){var e=$j("select#"+b+" option:not(:disabled):first").length?$j("select#"+b+" option:not(:disabled):first").val():
"";c&&($j.isArray(c)||(c=[c]),$j.each(c,function(g,h){g=$j("select#"+b+' option[value="'+h+'"]');if(g.length&&!g.is(":disabled"))return e=g.attr("value"),!1}));$j("select#"+b).val(e).trigger("change")}$j("select#"+b).hasClass("select2-hidden-accessible")&&$j.fn.select2&&($j("select#"+b).select2("destroy"),bookacti_select2_init())}}
