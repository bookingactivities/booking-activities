...
function bookacti_select2_sortable_init(){$j('.select2-hidden-accessible[data-sortable="1"] + .select2-container .bookacti-select2-selection.select2-selection--multiple .select2-selection__rendered').sortable({containment:"parent",items:".select2-selection__choice",update:function(a,b){var c=$j(b.item).parents(".select2-container").prev(".select2-hidden-accessible");c.length&&c.data("sortable")&&$j(b.item).parents(".select2-container").find(".select2-selection__choice").each(function(e,d){e=!1;"undefined"!==
typeof $j(d).data("data")&&"undefined"!==typeof $j(d).data("data").id&&(e=$j(d).data("data").id);if(!1===e)return!0;d=c.find('option[value="'+e+'"]');if(!d.length)return!0;d.detach();c.append(d)})}});$j("body").on("select2:select",'.bookacti-select2-ajax[data-sortable="1"], .bookacti-select2-no-ajax[data-sortable="1"]',function(a){"undefined"!==typeof a.params&&"undefined"!==typeof a.params.data&&"undefined"!==typeof a.params.data.id&&(a=a.params.data.id,a=$j(this).find('option[value="'+a+'"]'),a.length&&
(a.detach(),$j(this).append(a),$j(this).trigger("change")))})}
