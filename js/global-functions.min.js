...
function bookacti_select2_init(){if($j.fn.select2){var a={language:bookacti_localized.fullcalendar_locale,containerCssClass:"bookacti-select2-selection",selectionCssClass:"bookacti-select2-selection",dropdownCssClass:"bookacti-select2-dropdown",minimumResultsForSearch:1,width:"element",dropdownAutoWidth:!0,dropdownParent:$j(this).closest(".bookacti-backend-dialog").length?$j(this).closest(".bookacti-backend-dialog"):$j("body"),escapeMarkup:function(b){return b}};$j("body").trigger("bookacti_select2_init_data",
[a]);$j(".bookacti-select2-no-ajax:not(.select2-hidden-accessible)").select2(a);$j(".bookacti-select2-ajax:not(.select2-hidden-accessible)").select2($j.extend(!0,{ajax:{url:bookacti_localized.ajaxurl,dataType:"json",delay:1E3,data:function(b){var c=$j(this).data("type")?$j(this).data("type").trim():"";b={term:b.term,action:c?"bookactiSelect2Query_"+c:"bookactiSelect2Query",name:$j(this).attr("name")?$j(this).attr("name"):"",id:$j(this).attr("id")?$j(this).attr("id"):"",allow_current:$j(this).find('option[value="current"]').length?
1:0,nonce:bookacti_localized.nonce_query_select2_options};$j(this).trigger("bookacti_select2_query_data",[b]);return b},processResults:function(b){var c=[];"undefined"!==typeof b.options&&(c=b.options);c={results:c};$j(this).trigger("bookacti_select2_query_results",[c,b]);return c},cache:!0}},a))}}
