...
width:"element",dropdownAutoWidth:!0,dropdownParent:$j(this).closest(".bookacti-backend-dialog").length?$j(this).closest(".bookacti-backend-dialog"):$j("body"),escapeMarkup:function(a){return a},ajax:{url:bookacti_localized.ajaxurl,dataType:"json",delay:1E3,data:function(a){var b=$j(this).data("type")?$j(this).data("type").trim():"";a={term:a.term,action:b?"bookactiSelect2Query_"+b:"bookactiSelect2Query",name:$j(this).attr("name")?$j(this).attr("name"):"",id:$j(this).attr("id")?$j(this).attr("id"):
"",allow_current:$j(this).find('option[value="current"]').length?1:0,nonce:bookacti_localized.nonce_query_select2_options};$j(this).trigger("bookacti_select2_query_data",[a]);return a},processResults:function(a){var b=[];"undefined"!==typeof a.options&&(b=a.options);b={results:b};$j(this).trigger("bookacti_select2_query_results",[b,a]);return b},cache:!0}}))}
...
function bookacti_convert_php_datetime_format_to_moment_js(a){if("string"!==typeof a||!a.length)return"";for(var b={d:"DD",D:"ddd",j:"D",l:"dddd",N:"E",w:"d",W:"W",F:"MMMM",m:"MM",M:"MMM",n:"M",o:"GGGG",Y:"YYYY",y:"YY",a:"a",A:"A",g:"h",G:"H",h:"hh",H:"HH",i:"mm",s:"ss",u:"X",e:"z",O:"ZZ",P:"Z",T:"z",c:"YYYY-MM-DD[T]HH:mm:ssZ",r:"ddd, DD MMM YYYY HH:mm:ss ZZ",U:"X"},c=!1,e="",d=0;d<a.length;d++){var f=a[d];"\\"!==f||c?(e+=c||"undefined"===typeof b[f]?"["+f+"]":b[f],c=!1):c=!0}return e}
